...
const COPY: Record<Lang, Copy> = {
  en: {
    back: uiText('generatedUi.u_85647deec9865df5'), badge: uiText('generatedUi.u_a953ec3265030ca3'), title: uiText('generatedUi.u_44ff7cb3d8a65a00'), subtitle: uiText('generatedUi.u_3b80ab28989e0d21'), urlLabel: uiText('generatedUi.u_e9cb62d631733c50'), placeholder: uiText('generatedUi.u_100680ad546ce6a5'), scan: uiText('generatedUi.u_d3e491a08e9adf8b'), scanning: uiText('generatedUi.u_38d96da6e8b253d2'), hint: uiText('generatedUi.u_77073e6e91687e62'), trySample: uiText('generatedUi.u_470b58b8e271f524'), missingUrl: uiText('generatedUi.u_fae83b98fe90224a'), scanFailed: uiText('generatedUi.u_da02acc02eb77254'), ready: uiText('generatedUi.u_5fa7aac5375c5815'), begin: uiText('generatedUi.u_0bdbfa75aa2b32eb'), score: uiText('generatedUi.u_38e5a46cbc5ad328'), loadTime: uiText('generatedUi.u_2e8cbe13da056dad'), findings: uiText('generatedUi.u_e171c2ff25b55e5a'), high: uiText('generatedUi.u_c4ebc6d4a5832cd9'), medium: 'Medium', low: 'Low', pageChecked: uiText('generatedUi.u_311dd8c115a97a36'), topFindings: uiText('generatedUi.u_3b2fe8dcdb6bcf6e'), noFindings: uiText('generatedUi.u_f2d17ce6528e5523'), metrics: 'Page metrics', html: 'HTML', titleLength: 'Title length', descriptionLength: 'Description length', scripts: 'Scripts', stylesheets: 'Stylesheets', images: 'Images', missingAlt: 'Images missing alt', h1: 'H1 count', lazyImages: 'Lazy-loaded images', requestTitle: uiText('generatedUi.u_ee9f27236ed19a6c'), requestBody: uiText('generatedUi.u_f8dfe0406d9bce6c'), requestCta: uiText('generatedUi.u_25957a57952f7e25'), safeNote: uiText('generatedUi.u_a6620c323f961c7d'), detailLabel: 'What we found', fixLabel: 'Recommended fix', genericFinding: 'Optimization opportunity detected', genericDetail: (category, value) => value === undefined ? `This ${category} signal needs review.` : `This ${category} signal needs review. Observed value: ${value}.`, fixes: { performance: 'Improve loading speed, caching, image handling, and unnecessary scripts.', seo: 'Improve metadata, page structure, search visibility, and social previews.', accessibility: 'Improve accessibility signals such as language, image text, and semantic structure.', security: 'Improve public security headers and HTTPS trust signals.', conversion: 'Add a clear next step such as signup, demo, pricing, quote, or booking.' }, categories: { performance: uiText('generatedUi.u_442aded87a55aa8c'), seo: uiText('generatedUi.u_6bc4718fbb156bc9'), accessibility: uiText('generatedUi.u_d3368cbffe23c98d'), security: uiText('generatedUi.u_8f6fb4eb7f42c0e2'), conversion: uiText('generatedUi.u_1f04a8531a463901') }, severities: { high: uiText('generatedUi.u_c4ebc6d4a5832cd9'), medium: uiText('generatedUi.u_8e588cd187741f1c'), low: uiText('generatedUi.u_f793de205ead5ac3') },
  },
  pt: {
    back: 'SignalBoost', badge: 'Utilitário gratuito para sites', title: 'Teste a otimização do seu site gratuitamente.', subtitle: 'Cole uma URL pública e receba uma prévia rápida de desempenho, SEO, acessibilidade, segurança e conversão.', urlLabel: 'URL pública do site', placeholder: 'https://exemplo.com', scan: 'Executar verificação grátis', scanning: 'Verificando…', hint: 'Apenas páginas públicas. Prévia de uma página. Sem acesso privado e sem mudanças automáticas.', trySample: 'Testar SignalBoost', missingUrl: 'Cole primeiro uma URL pública.', scanFailed: 'Não foi possível verificar este site.', ready: 'Pronto', begin: 'Cole uma URL para começar', score: 'Pontuação', loadTime: 'Tempo de carga', findings: 'Constatações', high: 'Alta', medium: 'Média', low: 'Baixa', pageChecked: 'Página verificada', topFindings: 'Principais oportunidades de otimização', noFindings: 'Nenhum problema importante encontrado nesta prévia. Não é uma auditoria completa, mas é um bom primeiro sinal.', metrics: 'Métricas da página', html: 'HTML', titleLength: 'Tamanho do título', descriptionLength: 'Tamanho da descrição', scripts: 'Scripts', stylesheets: 'Folhas de estilo', images: 'Imagens', missingAlt: 'Imagens sem alt', h1: 'Quantidade de H1', lazyImages: 'Imagens com lazy loading', requestTitle: 'Solicitar plano de correção', requestBody: 'Envie este resultado ao motor COS Marketing + Vendas. Ele criará um lead com tags e preparará um follow-up aprovado pelo proprietário. Nada é enviado automaticamente.', requestCta: 'Solicitar plano de correção', safeNote: 'Nenhuma mudança ou follow-up acontece sem aprovação.', detailLabel: 'O que encontramos', fixLabel: 'Correção recomendada', genericFinding: 'Oportunidade de otimização detectada', genericDetail: (category, value) => value === undefined ? `Este sinal de ${category} precisa de revisão.` : `Este sinal de ${category} precisa de revisão. Valor observado: ${value}.`, fixes: { performance: 'Melhore velocidade de carga, cache, imagens e scripts desnecessários.', seo: 'Melhore metadados, estrutura da página, visibilidade de busca e prévias sociais.', accessibility: 'Melhore idioma, texto alternativo e estrutura semântica.', security: 'Melhore cabeçalhos públicos de segurança e sinais HTTPS.', conversion: 'Adicione um próximo passo claro como cadastro, demo, preço, orçamento ou reserva.' }, categories: { performance: 'Desempenho', seo: 'SEO', accessibility: 'Acessibilidade', security: 'Segurança', conversion: 'Conversão' }, severities: { high: 'Alta', medium: 'Média', low: 'Baixa' },
  },
  es: {
    back: 'SignalBoost', badge: 'Utilidad gratuita para sitios', title: 'Prueba gratis la optimización de tu sitio web.', subtitle: 'Pega una URL pública y recibe una vista previa rápida de rendimiento, SEO, accesibilidad, seguridad y conversión.', urlLabel: 'URL pública del sitio', placeholder: 'https://ejemplo.com', scan: 'Ejecutar revisión gratis', scanning: 'Revisando…', hint: 'Solo páginas públicas. Vista previa de una página. Sin acceso privado y sin cambios automáticos.', trySample: 'Probar SignalBoost', missingUrl: 'Pega primero una URL pública.', scanFailed: 'No se pudo revisar este sitio.', ready: 'Listo', begin: 'Pega una URL para comenzar', score: 'Puntuación', loadTime: 'Tiempo de carga', findings: 'Hallazgos', high: 'Alta', medium: 'Media', low: 'Baja', pageChecked: 'Página revisada', topFindings: 'Principales oportunidades de optimización', noFindings: 'No se encontraron problemas importantes en esta vista previa. No es una auditoría completa, pero es una buena primera señal.', metrics: 'Métricas de la página', html: 'HTML', titleLength: 'Longitud del título', descriptionLength: 'Longitud de la descripción', scripts: 'Scripts', stylesheets: 'Hojas de estilo', images: 'Imágenes', missingAlt: 'Imágenes sin alt', h1: 'Cantidad de H1', lazyImages: 'Imágenes con carga diferida', requestTitle: 'Solicitar plan de corrección', requestBody: 'Envía este resultado al motor COS Marketing + Ventas. Creará un lead etiquetado y preparará un seguimiento aprobado por el propietario. Nada se envía automáticamente.', requestCta: 'Solicitar plan de corrección', safeNote: 'No hay cambios ni seguimiento sin aprobación.', detailLabel: 'Lo que encontramos', fixLabel: 'Corrección recomendada', genericFinding: 'Oportunidad de optimización detectada', genericDetail: (category, value) => value === undefined ? `Esta señal de ${category} necesita revisión.` : `Esta señal de ${category} necesita revisión. Valor observado: ${value}.`, fixes: { performance: 'Mejora velocidad, caché, imágenes y scripts innecesarios.', seo: 'Mejora metadatos, estructura, visibilidad de búsqueda y vistas sociales.', accessibility: 'Mejora idioma, texto alternativo y estructura semántica.', security: 'Mejora cabeceras públicas de seguridad y señales HTTPS.', conversion: 'Agrega un siguiente paso claro como registro, demo, precios, cotización o reserva.' }, categories: { performance: 'Rendimiento', seo: 'SEO', accessibility: 'Accesibilidad', security: 'Seguridad', conversion: 'Conversión' }, severities: { high: 'Alta', medium: 'Media', low: 'Baja' },
  },
  pl: {
    back: 'SignalBoost', badge: 'Darmowe narzędzie dla stron', title: 'Sprawdź za darmo optymalizację swojej strony.', subtitle: 'Wklej publiczny URL i otrzymaj szybki podgląd wydajności, SEO, dostępności, bezpieczeństwa i konwersji.', urlLabel: 'Publiczny URL strony', placeholder: 'https://example.com', scan: 'Uruchom darmowe sprawdzenie', scanning: 'Skanowanie…', hint: 'Tylko publiczne strony. Podgląd jednej strony. Bez prywatnego dostępu i automatycznych zmian.', trySample: 'Sprawdź SignalBoost', missingUrl: 'Najpierw wklej publiczny URL.', scanFailed: 'Nie udało się sprawdzić tej strony.', ready: 'Gotowe', begin: 'Wklej URL, aby zacząć', score: 'Wynik', loadTime: 'Czas ładowania', findings: 'Wyniki', high: 'Wysoka', medium: 'Średnia', low: 'Niska', pageChecked: 'Sprawdzona strona', topFindings: 'Najważniejsze możliwości optymalizacji', noFindings: 'Nie znaleziono dużych problemów w tym podglądzie. To nie jest pełny audyt, ale dobry pierwszy sygnał.', metrics: 'Metryki strony', html: 'HTML', titleLength: 'Długość tytułu', descriptionLength: 'Długość opisu', scripts: 'Skrypty', stylesheets: 'Arkusze stylów', images: 'Obrazy', missingAlt: 'Obrazy bez alt', h1: 'Liczba H1', lazyImages: 'Obrazy z lazy loading', requestTitle: 'Poproś o plan poprawek', requestBody: 'Wyślij ten wynik do silnika COS Marketing + Sprzedaż. Utworzy otagowanego leada i przygotuje follow-up do akceptacji właściciela. Nic nie wysyła się automatycznie.', requestCta: 'Poproś o plan poprawek', safeNote: 'Bez zmian i follow-up bez akceptacji.', detailLabel: 'Co znaleźliśmy', fixLabel: 'Zalecana poprawka', genericFinding: 'Wykryto możliwość optymalizacji', genericDetail: (category, value) => value === undefined ? `Ten sygnał z kategorii ${category} wymaga przeglądu.` : `Ten sygnał z kategorii ${category} wymaga przeglądu. Zaobserwowana wartość: ${value}.`, fixes: { performance: 'Popraw szybkość, pamięć podręczną, obrazy i zbędne skrypty.', seo: 'Popraw metadane, strukturę strony, widoczność w wyszukiwarce i podglądy społecznościowe.', accessibility: 'Popraw język strony, tekst alternatywny i strukturę semantyczną.', security: 'Popraw publiczne nagłówki bezpieczeństwa i sygnały HTTPS.', conversion: 'Dodaj jasny następny krok, np. rejestrację, demo, cennik, wycenę lub rezerwację.' }, categories: { performance: 'Wydajność', seo: 'SEO', accessibility: 'Dostępność', security: 'Bezpieczeństwo', conversion: 'Konwersja' }, severities: { high: 'Wysoka', medium: 'Średnia', low: 'Niska' },
  },
  ru: {
    back: 'SignalBoost', badge: 'Бесплатный инструмент для сайтов', title: 'Бесплатно проверьте оптимизацию своего сайта.', subtitle: 'Вставьте публичный URL и получите быстрый обзор производительности, SEO, доступности, безопасности и конверсии.', urlLabel: 'Публичный URL сайта', placeholder: 'https://example.com', scan: 'Запустить бесплатную проверку', scanning: 'Проверка…', hint: 'Только публичные страницы. Обзор одной страницы. Без приватного доступа и автоматических изменений.', trySample: 'Проверить SignalBoost', missingUrl: 'Сначала вставьте публичный URL.', scanFailed: 'Не удалось проверить этот сайт.', ready: 'Готово', begin: 'Вставьте URL, чтобы начать', score: 'Оценка', loadTime: 'Время загрузки', findings: 'Замечания', high: 'Высокая', medium: 'Средняя', low: 'Низкая', pageChecked: 'Проверенная страница', topFindings: 'Главные возможности оптимизации', noFindings: 'В этом обзоре не найдено серьёзных проблем. Это не полный аудит, но хороший первый сигнал.', metrics: 'Метрики страницы', html: 'HTML', titleLength: 'Длина заголовка', descriptionLength: 'Длина описания', scripts: 'Скрипты', stylesheets: 'Таблицы стилей', images: 'Изображения', missingAlt: 'Изображения без alt', h1: 'Количество H1', lazyImages: 'Изображения с ленивой загрузкой', requestTitle: 'Запросить план исправлений', requestBody: 'Отправьте этот результат в COS Marketing + Sales engine. Он создаст tagged lead и подготовит follow-up для утверждения владельцем. Ничего не отправляется автоматически.', requestCta: 'Запросить план исправлений', safeNote: 'Без изменений и follow-up без утверждения.', detailLabel: 'Что найдено', fixLabel: 'Рекомендуемое исправление', genericFinding: 'Обнаружена возможность оптимизации', genericDetail: (category, value) => value === undefined ? `Этот сигнал категории ${category} требует проверки.` : `Этот сигнал категории ${category} требует проверки. Наблюдаемое значение: ${value}.`, fixes: { performance: 'Улучшите скорость, кеширование, изображения и лишние скрипты.', seo: 'Улучшите метаданные, структуру страницы, поиск и социальные превью.', accessibility: 'Улучшите язык страницы, alt-текст и семантическую структуру.', security: 'Улучшите публичные заголовки безопасности и сигналы HTTPS.', conversion: 'Добавьте понятный следующий шаг: регистрацию, демо, цены, заявку или бронирование.' }, categories: { performance: 'Производительность', seo: 'SEO', accessibility: 'Доступность', security: 'Безопасность', conversion: 'Конверсия' }, severities: { high: 'Высокая', medium: 'Средняя', low: 'Низкая' },
  },
}
