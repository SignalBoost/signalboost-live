...
// One final approval for a completed repository audit. The parent must provide
// the exact displayed run id; the component never guesses from finding counts.
...
const COPY: Record<string, Copy> = {
  en: {
    ...
    approve: 'Approve all fixes', decline: 'Not now', running: 'AI remediation is running…',
    ...
    noRun: 'Select a completed audit run before approving fixes.', viewPlans: 'View plans',
  },
  es: {
    ...
    approve: 'Aprobar todas las correcciones', decline: 'Ahora no', running: 'La remediación con IA está en curso…',
    ...
    noRun: 'Selecciona una auditoría completada antes de aprobar correcciones.', viewPlans: 'Ver planes',
  },
  pt: {
    ...
    approve: 'Aprovar todas as correções', decline: 'Agora não', running: 'A remediação por IA está em execução…',
    ...
    noRun: 'Selecione uma auditoria concluída antes de aprovar correções.', viewPlans: 'Ver planos',
  },
  pl: {
    ...
    approve: 'Zatwierdź wszystkie poprawki', decline: 'Nie teraz', running: 'Trwa automatyczna naprawa…',
    ...
    noRun: 'Wybierz zakończony audyt przed zatwierdzeniem poprawek.', viewPlans: 'Zobacz plany',
  },
  ru: {
    ...
    approve: 'Одобрить все исправления', decline: 'Не сейчас', running: 'ИИ выполняет исправления…',
    ...
    noRun: 'Выберите завершённый аудит перед одобрением исправлений.', viewPlans: 'Посмотреть планы',
  },
}
...
export default function RemediationBanner({
  ...
  const [phase, setPhase] = useState<'idle' | 'running' | 'done' | 'error'>(initialResult ? 'done' : 'idle')
