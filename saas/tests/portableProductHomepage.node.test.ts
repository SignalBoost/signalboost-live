...
test('homepage renders public products from the registry selector without PORTABLES metadata', () => {
  ...
  assert.deepEqual(ids, ['provider-hub', 'campaign-studio', 'integrations-hub', 'video-maker', 'control-center', 'marketing-sales', 'press-media', 'portable-ai-chief-of-staff', 'browser-agent-ecosystem', 'agent-operations-platform', 'self-healing-supervisor', 'ai-university', 'ai-distillation-engine'])
