...
export const NORMATIVE_ANSWER_POLICY: readonly string[] = [
  ...
  '- Present the strongest material arguments supporting and opposing the proposition fairly, without false balance: evidence quality may be weighed, but the user must not be told which moral or political position to adopt.',
