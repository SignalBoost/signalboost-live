...
const COPY: Record<Lang, Copy> = {
  en: { back: uiCopy('u_6378db8ec859a51c'), badge: uiCopy('u_8f5e659fb25cf3ea'), title: uiCopy('u_e7657b87364d6b53'), subtitle: uiCopy('u_0cc6502220390283'), repoLabel: uiCopy('u_922abe8a67969df1'), placeholder: uiCopy('u_a201a025f293996a'), check: uiCopy('u_1972646e2e9736bd'), checking: uiCopy('u_965cb3883b33dc36'), hint: uiCopy('u_deede49c38224bf3'), trySample: uiCopy('u_64c83e9741887f9d'), missingUrl: uiCopy('u_9e665a4cd788fd64'), checkFailed: uiCopy('u_7ecaa5c1ff5005f0'), ready: uiCopy('u_5f47c9fa25373537'), begin: uiCopy('u_275088ab1da7559e'), packages: uiCopy('u_4dad4c0bce691ce2'), findings: uiCopy('u_1d1d6c0e213f9a4c'), critical: uiCopy('u_8eb7d8f5ae767be0'), high: uiCopy('u_14f631c4bdd85c02'), repoChecked: uiCopy('u_69e9ff08b910234f'), topFindings: uiCopy('u_0e17f52ac718f9cb'), noFindings: uiCopy('u_8b7a51ae3d3559b6'), patched: uiCopy('u_f20cb0c105a84b2d'), source: uiCopy('u_0975fdf66b1fdc80'), requestTitle: uiCopy('u_06451a8f8f70e729'), requestBody: uiCopy('u_5593634903cb0f54'), requestCta: uiCopy('u_9023325769fd8151'), safeNote: uiCopy('u_659e4031a20757d4'), severities: { critical: uiCopy('u_ff2bc7013c2edf31'), high: uiCopy('u_0e259d72aa0d276a'), medium: uiCopy('u_fef6a4ee8f14de1f'), low: uiCopy('u_2af230765e827287'), unknown: uiCopy('u_b65b799675112ac8') } },
