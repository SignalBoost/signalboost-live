...
- Keep ONBOARD.md useful as durable documentation when appropriate, but an ONBOARD.md edit, change-log entry, or PR-body acknowledgement is not required for commit or merge.
