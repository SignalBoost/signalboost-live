...
const COPY: Record<Lang, Record<string, any>> = {
  en: { approvals: uiText('generatedUi.u_d0ea5e7a708947fa'), eyebrow: uiText('generatedUi.u_3879aa3f79ea7059'), title: uiText('generatedUi.u_14fd4fa3deecec70'), refresh: uiText('generatedUi.u_0e91610117029a62'), none: uiText('generatedUi.u_9baa14eba0627abc'), untitled: uiText('generatedUi.u_ed0fd179f1545359'), approve: uiText('generatedUi.u_6007acbe30b2cd98'), edit: uiText('generatedUi.u_32810250520806ef'), reject: uiText('generatedUi.u_ab604a360777735f'), archive: uiText('generatedUi.u_66f4804ee23ddc09'), publishing: uiText('generatedUi.u_9e48e39b3247799d'), viewAll: uiText('generatedUi.u_815f94deb134381c'), status: { draft: "Draft", waiting_approval: "Pending approval", approved: "Approved", queued: "Queued", running: "Running", rejected: "Rejected" }, channel: { youtube: "YouTube", short_video: "Short video", linkedin: "LinkedIn", blog: "Blog", email: "Email", outreach: "Outreach", landing_page: "Landing page", review_campaign: "Review campaign", campaign: "Campaign" } },
