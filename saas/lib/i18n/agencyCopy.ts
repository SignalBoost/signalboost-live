...
const en: AgencyCopy = {
  hero: {
    ...
    title: 'Your entire campaign. One prompt. Minutes, not weeks.',
    body: 'Describe what you want to promote in one sentence. The AI writes your YouTube copy, LinkedIn posts, and press release, then dispatches your press outreach to real journalists — in your language, with your approval on everything before it goes out. No agency, no retainers.',
    primaryCta: 'Create my campaign now',
    secondaryCta: 'Review enterprise rail',
  },
  client: {
    title: 'From one prompt to a finished campaign',
    body: 'Tell SignalBoost what you are announcing. It writes, packages, and queues your complete organic campaign — YouTube, LinkedIn, and press-release email dispatch to journalists — ready in minutes. You stay in control: every dispatch waits for your approval.',
