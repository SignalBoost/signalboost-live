...
- Provenance follow-up routing — requests for where a prior answer or answers came from are served from recorded execution telemetry before freshness routing; they never trigger an unrelated live search.
