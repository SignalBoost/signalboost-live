...
const PLANS = [
  {
    ...
    features: [
      ...
      'Basic clip generation (5 clips/ep)',
      'Podcast website',
      'Listener reviews',
      'Email support',
    ],
  ...
  },
  {
    ...
    features: [
      ...
      'Unlimited episodes',
      'All 5 languages',
      'Native AI voiceover (priority)',
      'Captions in all 5 languages',
      'Clip factory (unlimited clips)',
      'Multi-language podcast website',
      'Listener reviews + analytics',
      'Transcript in all languages',
      'Priority support',
    ],
    cta: 'Start free trial',
    highlight: true,
  },
  {
    ...
    features: [
      ...
      'Native AI voiceover (dedicated)',
      'Custom caption formats (SRT, VTT, ASS)',
      'Clip factory (unlimited)',
      'White label website',
...
const HOW_IT_WORKS = [
  { step: '01', title: 'Upload your episode', desc: 'Drop your finished audio or video file. We support MP3, MP4, WAV and more. No raw editing needed — bring us your final cut.' },
  { step: '02', title: 'Choose your languages', desc: 'Select which languages you want your episode in. Pick from English, Portuguese, Spanish, Polish and Russian.' },
  { step: '03', title: 'We generate everything', desc: 'Native AI voiceover, captions, short clips for social, translated show notes — all done automatically.' },
  { step: '04', title: 'Publish everywhere', desc: 'Download your multilingual episodes and clips, or publish directly to your SignalBoost podcast website.' },
]
    ...
    <main style={{ minHeight: '100vh', background: '#0a0a0f', color: '#fff', fontFamily: 'system-ui' }}>
      ...
      <section style={{ maxWidth: 800, margin: '0 auto', padding: '80px 24px 60px', textAlign: 'center' }}>
        ...
        <p style={{ color: 'rgba(255,255,255,0.25)', fontSize: 13, lineHeight: 1.6, maxWidth: 480, margin: '0 auto 40px', fontStyle: 'italic' }}>
          We don't do hardware or raw audio editing. Bring us your finished episode — we handle everything after that.
        </p>

        <div style={{ display: 'flex', gap: 12, justifyContent: 'center', flexWrap: 'wrap' }}>
          <Link href="#plans"
            style={{ background: '#ffc300', color: '#000', fontWeight: 800, fontSize: 15, padding: '14px 36px', borderRadius: 999, textDecoration: 'none' }}>
            See plans
          </Link>
          <Link href="#how-it-works"
            style={{ background: 'rgba(255,255,255,0.05)', color: '#fff', fontWeight: 600, fontSize: 15, padding: '14px 36px', borderRadius: 999, border: '1px solid rgba(255,255,255,0.12)', textDecoration: 'none' }}>
            How it works →
          </Link>
        </div>
        ...
        <div style={{ display: 'flex', justifyContent: 'center', gap: 48, marginTop: 56, flexWrap: 'wrap' }}>
          {[
            ...
            { value: '< 2hr', label: 'Turnaround' },
            { value: 'SRT/VTT', label: 'Caption formats' },
            { value: '30 days', label: 'Free trial' },
          ].map(s => (
            <div key={s.label} style={{ textAlign: 'center' }}>
              <div style={{ fontSize: 32, fontWeight: 900, color: '#ffc300', letterSpacing: '-0.02em' }}>{s.value}</div>
      ...
      <section id="how-it-works" style={{ maxWidth: 1100, margin: '0 auto', padding: '60px 24px' }}>
        <h2 style={{ fontSize: 36, fontWeight: 900, letterSpacing: '-0.02em', textAlign: 'center', marginBottom: 48 }}>
          How it works
        </h2>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 20 }}>
          {HOW_IT_WORKS.map((step, i) => (
            <div key={step.step} style={{
              ...
              <div style={{ fontSize: 48, fontWeight: 900, color: 'rgba(255,195,0,0.15)', letterSpacing: '-0.03em', marginBottom: 12 }}>
                {step.step}
              </div>
              ...
              {i < HOW_IT_WORKS.length - 1 && (
                <div style={{ position: 'absolute', right: -12, top: '50%', transform: 'translateY(-50%)', fontSize: 20, color: 'rgba(255,195,0,0.3)', zIndex: 1 }}>→</div>
              )}
            </div>
          ))}
        </div>
      ...
      <section style={{ maxWidth: 1100, margin: '0 auto', padding: '0 24px 60px' }}>
        <h2 style={{ fontSize: 36, fontWeight: 900, letterSpacing: '-0.02em', textAlign: 'center', marginBottom: 16 }}>
          What we deliver
        </h2>
        <p style={{ textAlign: 'center', color: 'rgba(255,255,255,0.4)', fontSize: 15, maxWidth: 500, margin: '0 auto 48px' }}>
          Everything after the recording. You focus on the content — we handle the global distribution.
        </p>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 16 }}>
          {[
            ...
            { icon: '💬', title: 'Multilingual captions', desc: 'Auto-generated subtitles in all your languages. Download as SRT, VTT or burn them directly into your video.' },
            { icon: '✂️', title: 'Social clips', desc: 'Short-form clips optimized for TikTok, Instagram Reels and YouTube Shorts — in every language.' },
            { icon: '📝', title: 'Translated show notes', desc: 'Episode summaries and show notes written natively in each language — not machine translated.' },
            { icon: '🌐', title: 'Podcast website', desc: 'A branded site with episode player, show notes, and a multilingual language switcher.' },
            { icon: '⭐', title: 'Listener reviews', desc: 'Collect and display listener testimonials in their native language to build social proof.' },
          ].map(item => (
      ...
      <section id="demo" style={{ maxWidth: 700, margin: '0 auto', padding: '0 24px 60px', textAlign: 'center' }}>
        <div style={{
          background: 'rgba(255,195,0,0.04)', border: '1px solid rgba(255,195,0,0.2)',
          borderRadius: 20, padding: '40px 32px',
        }}>
          <div style={{ fontSize: 40, marginBottom: 16 }}>🎧</div>
          <h2 style={{ fontSize: 24, fontWeight: 900, margin: '0 0 12px' }}>Hear the difference</h2>
          <p style={{ color: 'rgba(255,255,255,0.45)', fontSize: 14, margin: '0 0 24px', lineHeight: 1.6 }}>
            Listen to the same 30-second clip in all 5 languages. Native voices, not robotic translations.
          </p>
          <div style={{ display: 'flex', gap: 10, justifyContent: 'center', flexWrap: 'wrap' }}>
            {[
              ...
              <button key={l.lang}
                ...
                onMouseEnter={e => (e.currentTarget.style.borderColor = 'rgba(255,195,0,0.4)')}
          ...
          <p style={{ fontSize: 11, color: 'rgba(255,255,255,0.2)', marginTop: 20 }}>
            Audio samples coming soon — sign up to be notified
          </p>
        </div>
      </section>

      <section id="plans" style={{ maxWidth: 1100, margin: '0 auto', padding: '0 24px 80px' }}>
        <h2 style={{ fontSize: 36, fontWeight: 900, letterSpacing: '-0.02em', textAlign: 'center', marginBottom: 12 }}>
          Podcast plans
        </h2>
          ...
          {PLANS.map(plan => (
            <div key={plan.name} style={{
              ...
              <div>
                <button
                  onClick={() => {
                    if (plan.name === 'Network') {
                      window.location.href = 'mailto:cadomos@gmail.com?subject=SignalBoost Network Plan'
                    } else {
                  ...
                  style={{
                    ...
                    borderRadius: 999, padding: '12px 0', fontSize: 13, fontWeight: 800,
      ...
      <section style={{ maxWidth: 700, margin: '0 auto', padding: '0 24px 120px', textAlign: 'center' }}>
        <div style={{
          ...
          <h2 style={{ fontSize: 32, fontWeight: 900, margin: '0 0 14px', letterSpacing: '-0.02em' }}>
            Ready to go global?
          </h2>
          <p style={{ color: 'rgba(255,255,255,0.4)', fontSize: 15, margin: '0 0 32px', lineHeight: 1.6 }}>
            You record it. We handle the rest — voiceover, captions, clips, website and reviews in 5 languages.
          </p>
          <Link href="/pricing"
            style={{ background: '#ffc300', color: '#000', fontWeight: 800, fontSize: 15, padding: '14px 40px', borderRadius: 999, textDecoration: 'none', display: 'inline-block' }}>
