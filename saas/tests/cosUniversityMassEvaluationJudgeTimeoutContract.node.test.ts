...
test('case-score persistence coexists with the repaired bounded judge timeout', () => {
...
test('judge repair does not change endpoint, judge-call, or route reserve ceilings', () => {
