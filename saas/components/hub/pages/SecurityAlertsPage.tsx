  ...
  return (
    <div className="hub-panel" style={{ height: '100%', overflowY: 'auto', paddingRight: 8 }}>
      <section style={{ marginBottom: 14 }}>
        ...
        <h2 style={{ margin: '4px 0', fontSize: 26 }}>Security Alerts</h2>
        <p style={{ margin: 0, color: 'rgba(255,255,255,.58)', fontSize: 13.5 }}>One job: show what is dangerous and what should be fixed first.</p>
      </section>
      ...
      <section style={{ ...cardStyle, padding: 16 }}>
        <h3 style={{ margin: '0 0 12px' }}>Open Security Findings</h3>
