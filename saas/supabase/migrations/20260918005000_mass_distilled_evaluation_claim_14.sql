-- Forward repair: align the atomic mass-evaluation claim contract with the owner-approved 14-call ceiling.
-- This migration intentionally recreates the function rather than mutating historical migration files.
-- Atomically reserve the next exact-canaried mass artifact for bounded independent evaluation.
