  ...
  return (
    <div className="hub-panel" style={{ height: '100%', overflowY: 'auto', paddingRight: 8 }}>
      <section style={{ marginBottom: 14 }}>
        ...
        <h2 style={{ margin: '4px 0', fontSize: 26 }}>{t(dict, 'console.aiOps.title', 'AI Operations Center')}</h2>
        <p style={{ margin: 0, color: 'rgba(255,255,255,.58)', fontSize: 13.5 }}>{t(dict, 'console.aiOps.subtitle', 'One job: tell the owner what to fix first across health, security, cost, and setup.')}</p>
      </section>
      <section style={{ ...cardStyle, padding: 16 }}>
        <h3 style={{ margin: '0 0 12px' }}>{t(dict, 'console.aiOps.recommended', 'Recommended Actions')}</h3>
