...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-brand-bg text-brand-text font-sans antialiased">
      {/* Navigation Header */}
      <header className="border-b border-brand-surface/50 bg-brand-bg/80 backdrop-blur-md sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <span className="text-xl font-bold bg-gradient-to-r from-brand-primary to-brand-secondary bg-clip-text text-transparent tracking-wide">
              SignalBoost
            </span>
            <span className="px-2 py-0.5 text-xs font-semibold bg-brand-primary/10 text-brand-primary rounded-full border border-brand-primary/20">
              Beta
            </span>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <Link href="/signup" className="px-4 py-2 text-sm font-medium bg-brand-primary hover:opacity-90 text-white rounded-lg transition-all shadow-lg shadow-brand-primary/20">
              Get Started
            </Link>
          </div>
        </div>
      ...
      <section className="relative pt-24 pb-20 md:pt-32 md:pb-28 overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,_var(--tw-gradient-stops))] from-brand-primary/10 via-transparent to-transparent opacity-70 pointer-events-none" />
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link href="/generator" className="w-full sm:w-auto px-8 py-4 bg-gradient-to-r from-brand-primary to-brand-secondary hover:opacity-90 text-white font-semibold rounded-xl transition-all shadow-xl shadow-brand-secondary/20 text-center">
              Launch AI Website Generator
            </Link>
            <Link href="/dashboard" className="w-full sm:w-auto px-8 py-4 bg-brand-surface border border-brand-surface/80 hover:bg-brand-surface/60 text-brand-text font-semibold rounded-xl transition-colors text-center">
              View Dashboard
            </Link>
          </div>
        </div>
      ...
      {/* Features Grid */}
      <section id="features" className="py-20 border-t border-brand-surface/40 bg-brand-bg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Feature 1 */}
            <div className="p-6 rounded-2xl bg-brand-surface/30 border border-brand-surface/50 hover:border-brand-surface transition-all group">
              <div className="w-12 h-12 rounded-xl bg-brand-primary/10 flex items-center justify-center border border-brand-primary/20 mb-5 text-brand-primary group-hover:bg-brand-primary group-hover:text-white transition-all">
                🖥️
              </div>
            ...
            {/* Feature 2 */}
            <div className="p-6 rounded-2xl bg-brand-surface/30 border border-brand-surface/50 hover:border-brand-surface transition-all group">
              <div className="w-12 h-12 rounded-xl bg-brand-secondary/10 flex items-center justify-center border border-brand-secondary/20 mb-5 text-brand-secondary group-hover:bg-brand-secondary group-hover:text-white transition-all">
                🎙️
              </div>
      ...
      <section id="languages" className="py-20 border-t border-brand-surface/40 bg-brand-surface/10">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-3 max-w-3xl mx-auto">
            {["English (US/UK)", "Español", "Português", "Polski", "Русский"].map((lang, index) => (
              <span key={index} className="px-4 py-2 bg-brand-surface border border-brand-surface/40 text-brand-text rounded-xl text-sm font-medium shadow-sm">
                🌐 {lang}
              </span>
            ))}
          </div>
      ...
      <section id="pricing" className="py-20 border-t border-brand-surface/40 bg-brand-bg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <div className="max-w-md mx-auto grid gap-8 lg:max-w-4xl lg:grid-cols-2">
            {/* Starter Plan */}
            <div className="p-8 rounded-2xl bg-brand-surface/20 border border-brand-surface/40 flex flex-col justify-between">
              <div>
              ...
              <Link href="/signup" className="block w-full py-3 bg-brand-surface hover:bg-brand-surface/80 border border-brand-surface/60 text-brand-text font-medium rounded-xl text-center transition-colors">
                Start Free Trial
              </Link>
            </div>

            {/* Pro Plan */}
            <div className="p-8 rounded-2xl bg-gradient-to-b from-brand-surface/40 to-brand-secondary/5 border border-brand-secondary/20 flex flex-col justify-between relative shadow-2xl">
              <div className="absolute top-0 right-8 -translate-y-1/2 px-3 py-1 bg-brand-primary text-white text-xs font-semibold uppercase tracking-wider rounded-full">
                Popular
              </div>
              <div>
                ...
                <ul className="space-y-3 text-sm text-brand-text/90 mb-8">
                  <li className="flex items-center gap-2 text-brand-primary font-semibold">✓ Everything in Starter</li>
              ...
              <Link href="/signup" className="block w-full py-3 bg-brand-primary hover:opacity-95 text-white font-medium rounded-xl text-center transition-all shadow-lg shadow-brand-primary/20">
                Upgrade to Pro
              </Link>
            </div>
          </div>
      ...
      {/* Footer */}
      <footer className="border-t border-brand-surface/40 bg-brand-bg text-xs text-brand-muted/60 py-8">
