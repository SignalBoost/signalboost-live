  ...
  return (
    <>
      <style>{`
        ...
        @media (min-width: 1281px) and (max-width: 1650px) { .sbnav { gap: 9px; padding-inline: 16px; } .sbnav-desktop { display: flex; gap: 1px; } .sbnav-desktop .sbnav-menu { display: none; } .sbnav-search { display: none; } .sbnav-trigger { padding-inline: 7px; } .sbnav-language, .sbnav-auth, .sbnav-credits { display: inline-flex; } .sbnav-burger { display: inline-flex; margin-left: auto; } }
