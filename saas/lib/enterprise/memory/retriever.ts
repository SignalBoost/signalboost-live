...
export async function retrieveEnterpriseMemoryContext(args: {
  ...
  // IMPORTANT: use the canonical reader here. It combines measured campaign outcomes with the
  // current Enterprise Memory generation baseline. Re-deriving only campaign outcomes here caused
  // the live answer path to bypass generationDefaults and refuse when measuredCampaigns === 0.
