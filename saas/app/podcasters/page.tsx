...
const HOW_IT_WORKS = [
  { step: '01', title: 'Upload your episode', desc: 'Drop your finished audio or video file. We support MP3, MP4, WAV and more.' },
  ...
  return (
    <main style={{ minHeight: '100vh', background: '#0a0a0f', color: '#fff', fontFamily: 'system-ui' }}>
      ...
      <section id="plans" style={{ maxWidth: 1100, margin: '0 auto', padding: '0 24px 80px' }}>
        ...
        <p style={{ textAlign: 'center', color: 'rgba(255,255,255,0.4)', fontSize: 15, marginBottom: 32 }}>All plans include a 30-day free trial. No credit card required to start.</p>
