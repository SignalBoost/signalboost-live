...
Keep `ONBOARD.md` current when durable documentation helps future contributors, but an `ONBOARD.md` edit, change-log entry, or PR-body acknowledgement is not required for commit or merge.
