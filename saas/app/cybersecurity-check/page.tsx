...
const COPY: Record<Lang, Copy> = {
  en: { back: uiCopy('u_2f98f49eb1176284'), badge: uiCopy('u_b6ae16dc2c6853be'), title: uiCopy('u_9d0b11c56ef4fb59'), subtitle: uiCopy('u_a9611cea64e18805'), urlLabel: uiCopy('u_023b4b3ab4eac12a'), placeholder: uiCopy('u_5e29c15504bdf9db'), scan: uiCopy('u_bf6982d32aac8c88'), scanning: uiCopy('u_58ff2092f0778d48'), hint: uiCopy('u_eb1211de84cb39a9'), trySample: uiCopy('u_cd3afaf5cefc7ff0'), missingUrl: uiCopy('u_3f0c2331ab8d2463'), scanFailed: uiCopy('u_36034f1e7a98b239'), ready: uiCopy('u_6ea5bcb6ca351db5'), begin: uiCopy('u_366dcf63e2f128ae'), score: uiCopy('u_888883ea259a34a3'), response: uiCopy('u_a979a3663b3605df'), findings: uiCopy('u_3b43ece0b2f29c28'), high: uiCopy('u_078b8b7489d66a21'), pageChecked: uiCopy('u_5d7d3b32095631f3'), topFindings: uiCopy('u_4f2ce8bd85b63e1a'), noFindings: uiCopy('u_b4b38b5061d2e484'), signals: uiCopy('u_82943bcfe0320d68'), requestTitle: uiCopy('u_7f8b7074279b8c38'), requestBody: uiCopy('u_2aa652c7fce8cac1'), requestCta: uiCopy('u_acf2c521931d6d2e'), safeNote: uiCopy('u_a15b47bec594c117'), categories: { transport: uiCopy('u_95e5dbe6fcf1365d'), headers: uiCopy('u_a752d166e61d8e74'), cookies: uiCopy('u_d5886591b2fddcd0'), content: uiCopy('u_89c89a15ae83b47c'), exposure: uiCopy('u_6cf14def795b1168') }, severities: { high: uiCopy('u_da9354329c9ad593'), medium: uiCopy('u_ae22962e8f064880'), low: uiCopy('u_6bc3b4f72514cf09') } },
