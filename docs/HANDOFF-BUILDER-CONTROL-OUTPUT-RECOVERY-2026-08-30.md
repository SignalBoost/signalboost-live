...
This proves the repository-access route was active. The remaining defect was inside Builder's model-control protocol.
...
- deterministic completion after the repaired typecheck passes.
