...
const GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { icon: '🛠️', labelKey: 'nav.apprentice', fallbackLabel: 'Workshop Apprentice', href: '/dashboard/apprentice' },
  ...
  },
  {
    ...
    items: [
      ...
      { icon: '✅', labelKey: 'nav.supervisorAcceptance', fallbackLabel: 'Supervisor Acceptance', href: '/dashboard/supervisor/acceptance', requiresOwner: true },
      { icon: '🧩', labelKey: 'nav.providerHubStatus', fallbackLabel: 'Provider Hub Status', href: '/dashboard/provider-hub', requiresOwner: true },
      { icon: '📦', labelKey: 'nav.portableReadiness', fallbackLabel: 'Portable Readiness', href: '/dashboard/portable-products/readiness', requiresOwner: true },
      { icon: '📊', labelKey: 'nav.adminOverview', fallbackLabel: 'Admin Overview', href: '/admin/overview', requiresOwner: true },
      { icon: '💰', labelKey: 'nav.adminRevenue', fallbackLabel: 'Revenue (MRR)', href: '/admin/revenue', requiresOwner: true },
      { icon: '⚙️', labelKey: 'nav.adminSettings', fallbackLabel: 'System Settings', href: '/admin/settings', requiresOwner: true },
      { icon: '📨', labelKey: 'nav.hubEmailHealth', fallbackLabel: 'Email Health', href: '/hub/audit/email', requiresOwner: true },
      { icon: '▲', labelKey: 'nav.hubVercel', fallbackLabel: 'Vercel Panel', href: '/hub/vercel', requiresOwner: true },
    ],
  },
]
