...
export default function CommandConsole({
  ...
  const tier = getConsoleTier(tierId, dict)
  const providers = getTierProviders(tierId, dict)
  ...
  const focusProvider = focusProviderId ? getConsoleProvider(focusProviderId, dict) : null
