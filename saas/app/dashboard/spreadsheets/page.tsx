...
export default function SpreadsheetsWireframePage() {
  return (
    <main className="sb-hmi-shell">
      <section className="sb-hmi-hero" aria-labelledby="module-title">
        ...
        <h1 id="module-title">▦ Spreadsheets</h1>
        <p>Preview collaborative office-utility grids, sharing controls, and activity streams before production build.</p>
      ...
      <section className="sb-hmi-module" style={{ marginTop: 24 }} tabIndex={0}>
        <div className="sb-hmi-module__top">
          ...
          <div>
            ...
            <h2>Spreadsheets cockpit layout</h2>
          </div>
          <strong>01</strong>
        </div>
        <div className="sb-hmi-module__grid">
          <div className="sb-hmi-panel sb-hmi-panel--primary"><span>Collaborative table grid</span><div className="sb-hmi-form-lines"><i /><i /><i /></div></div>
          <div className="sb-hmi-panel"><span>Sharing panel</span><div className="sb-hmi-chart"><span style={{ height: '36%', background: 'linear-gradient(180deg, #1af0ff, rgba(26,240,255,.18))' }} /><span style={{ height: '70%', background: 'linear-gradient(180deg, #1af0ff, rgba(26,240,255,.18))' }} /><span style={{ height: '52%', background: 'linear-gradient(180deg, #1af0ff, rgba(26,240,255,.18))' }} /><span style={{ height: '86%', background: 'linear-gradient(180deg, #1af0ff, rgba(26,240,255,.18))' }} /></div></div>
          <div className="sb-hmi-panel"><span>Activity feed</span><div className="sb-hmi-feed"><i /><i /><i /></div></div>
        </div>
      </section>
    </main>
  )
