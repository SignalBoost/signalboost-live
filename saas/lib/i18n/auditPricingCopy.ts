...
export const AUDIT_PRICING_COPY: AuditPricingI18n = {
  en: {
    ...
    tiers: {
      ...
      pro: {
        ...
        features: [
          ...
          'Soporte dedicado',
          'Acceso a API',
          'Exportaciones con marca blanca',
          'Marca personalizada',
        ],
        ctaLabel: 'Comenzar',
        popularBadge: '',
    ...
    tiers: {
      ...
      pro: {
        ...
        features: [
          ...
          'Suite completa de auditoria',
          'Suporte dedicado',
          'Acesso à API',
          'Exportações com marca branca',
          'Marca personalizada',
        ],
        ctaLabel: 'Começar',
        popularBadge: '',
    ...
    tiers: {
      ...
      pro: {
        ...
        features: [
          ...
          'Pełny pakiet audytowy',
          'Dedykowane wsparcie',
          'Dostęp do API',
          'Eksporty white-label',
          'Własna marka',
        ],
        ctaLabel: 'Rozpocznij',
        popularBadge: '',
