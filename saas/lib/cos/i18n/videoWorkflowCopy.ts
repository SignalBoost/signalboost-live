export type VideoWorkflowCopy = {
  ...
  creatingCampaign: string
  generatedByCosa: string
...
const en: VideoWorkflowCopy = {
  ...
  createCampaign: 'Ask COSA to create video',
  creatingCampaign: 'Creating video concept...',
  generatedByCosa: 'Generated by COSA',
