...
const COPY: Record<Lang, Record<string, any>> = {
  en: { approvals: uiCopy('u_8923ad71bb80a02f'), eyebrow: uiCopy('u_02e3d1b685cdf9f1'), title: uiCopy('u_c7946f79a0e09591'), refresh: uiCopy('u_4a735c0ac0ee8eee'), none: uiCopy('u_06e01d27a6b4c07f'), untitled: uiCopy('u_e397ced94ef9a579'), approve: uiCopy('u_83f56112cc6a7ca8'), edit: uiCopy('u_c1ae0574a5742f9e'), reject: uiCopy('u_d9f35eba2f25e4ca'), archive: uiCopy('u_499d1eeabc98fc61'), publishing: uiCopy('u_0209876d29ce2524'), viewAll: uiCopy('u_89128f91d975036b'), status: { draft: uiCopy('u_1132937c3708d6a0'), waiting_approval: uiCopy('u_1d0f64d71f3f06e4'), approved: uiCopy('u_2197c6d1bd7a97dd'), queued: uiCopy('u_878e081561864569'), running: uiCopy('u_4c1986d7347b2a32'), rejected: uiCopy('u_4495c8c09ef70f44') }, channel: { youtube: uiCopy('u_5c1c1759e07cb6b3'), short_video: uiCopy('u_ce8ac75d4faf2ad1'), linkedin: uiCopy('u_d0a6151748ef1f2b'), blog: uiCopy('u_3834aa5a4341bc65'), email: uiCopy('u_b04df500431d4865'), outreach: uiCopy('u_6389b51f9a97f3c1'), landing_page: uiCopy('u_60c971dc9f5eca39'), review_campaign: uiCopy('u_56073ba3eb4a927d'), campaign: uiCopy('u_5563f4fea4062065') } },
