...
**COS communication-intelligence follow-up:** PR #1844 merged as `9eb7202d0fec9f3c818ba6398d5b9fda19259504`; PR #1845 merged as `dbd4e317f69c4520df315e865f7bcd1e0126c5dd`. Both exact Production deployments were READY, but real public Concierge observations **failed runtime acceptance**. The first invented a Subject line, recipient/signature placeholders and generic HR framing; the owner's exact Foreign Service draft then remained accusatory (`claim`), directive, compressed and literal even after the actual prompt-precedence repair. Prompt instructions and a writer's self-reported release score are therefore insufficient evidence of writing quality. The final owner-authorized attempt is active on `fix/cos-comparative-writing-gate-20260905`: careful/delicate correspondence receives a separate neural evaluator that compares the candidate with the original on meaning fidelity, diplomacy, elegance, authentic voice, unsupported additions and non-literal reconstruction; a failing candidate receives one critique-bound repair and independent re-evaluation. The redundant unconditional fourth copy-edit is skipped for the already-reviewed strategic path because it could degrade an accepted draft. The narrow framing guard from #1845 remains. If the next exact Production observation is not materially more elegant and diplomatic, revert #1844/#1845 and this attempt to the pre-change behavior at `49a141f454ea1f27906580a5322c325bfdb5e468`; do not continue stacking prompt patches.
