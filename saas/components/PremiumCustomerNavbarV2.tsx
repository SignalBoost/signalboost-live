...
const CUSTOMER_GROUPS: Group[] = [
  ...
  },
  {
    ...
    width: 540,
    items: [
      { icon: '🧭', label: 'Marketing + Sales Engine Setup', href: '/onboarding', desc: 'Continue product setup and personalize the Marketing + Sales workspace.' },
      { icon: '📧', label: 'Email Outreach Command Center', href: '/dashboard/outreach', desc: 'Email contacts, messages, campaigns, and pipeline work.' },
