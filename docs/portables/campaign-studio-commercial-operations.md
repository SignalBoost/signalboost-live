...
Status: product-specific operating guidance for the existing Campaign Studio implementation. This document does not prove immutable package delivery, entitlement enforcement, fulfillment, completed recovery rehearsal, clean-environment deployment, or production acceptance.
