  ...
  return (
    <main className="min-h-screen bg-[#05070b] px-6 py-8 text-white md:px-10">
      ...
      <section className="mt-10 rounded-[2rem] border border-[#FFD700]/25 bg-[radial-gradient(circle_at_top_left,rgba(255,215,0,.22),transparent_34%),linear-gradient(135deg,#111827,#05070b)] p-8 shadow-2xl">
        <p className="text-xs uppercase tracking-[0.35em] text-[#FFD700]">Temporary deployment</p>
        <h1 className="mt-4 max-w-4xl text-4xl font-black md:text-6xl">Staging cockpit for SignalBoost SaaS testing.</h1>
        <p className="mt-5 max-w-3xl text-lg leading-8 text-white/72">{stagingDeployment.purpose} Use this page as the QA entry point for Marketplace, pricing, dashboard modules, and multilingual smoke checks before promoting a build.</p>
        <div className="mt-6 flex flex-wrap gap-3 text-sm">
          <span className="rounded-full border border-white/10 bg-white/[.06] px-4 py-2">Project: {stagingDeployment.project}</span>
          <span className="rounded-full border border-white/10 bg-white/[.06] px-4 py-2">Environment: {stagingDeployment.environment}</span>
          <span className="rounded-full border border-white/10 bg-white/[.06] px-4 py-2">Release: {stagingDeployment.releaseLabel}</span>
        </div>
      </section>
      ...
      <section className="mt-8 grid gap-6 lg:grid-cols-[1fr_.8fr]">
        <article className="rounded-3xl border border-white/10 bg-white/[.04] p-6">
          <h2 className="text-2xl font-bold">SaaS module smoke test matrix</h2>
        ...
        <aside className="rounded-3xl border border-[#FFD700]/20 bg-[#FFD700]/10 p-6">
          <h2 className="text-2xl font-bold text-[#FFD700]">QA checklist</h2>
      ...
      <section className="mt-8 rounded-3xl border border-white/10 bg-black/35 p-6">
        <h2 className="text-xl font-bold">Localized route coverage</h2>
        <p className="mt-2 text-white/60">Verify each route with the language switcher across {stagingDeployment.locales.join(', ')}.</p>
