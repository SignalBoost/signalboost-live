...
**Builder certification visibility:** merged as `32085c7ad4fa6f69e873557498a130986615ee86`. Its first Production build exposed an i18n-gate failure: the new English certification label was not registered in all five locale dictionaries. The follow-up repair moves the English label into `generatedUi` and registers matching Spanish, Portuguese, Polish, and Russian values. Do not call this surface Production-accepted until the corrected deployment is READY.
