...
export type CosCurriculumTrack = { id:'cyber_defense'|'software_engineering'|'agent_systems'|'ml_data_engineering'|'ai_systems_safety'|'cognitive_science'|'robotics_edge_ai'|'space_science'|'applied_physics'|'computational_creativity'|'industrial_hmi'; title:string; topics:string[]; evaluation:string[]; safetyBoundary:string }
