    ...
    <main style={{ padding: 24, color: '#fff', maxWidth: 1200, margin: '0 auto' }}>
      ...
      <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap', alignItems: 'stretch', marginBottom: 24 }}>
        ...
        <div style={{
          ...
          <div>
            <div style={{ fontSize: 11, fontWeight: 800, color: 'rgba(255,255,255,.5)', textTransform: 'uppercase', letterSpacing: '.06em', marginBottom: 4 }}>{uiText('generatedUi.u_38e5a46cbc5ad328')}</div>
                  ...
                  return (
                    <tr key={i} style={{ borderBottom: '1px solid rgba(255,255,255,.05)' }}>
                      <td style={{ padding: '10px 12px', color: '#fff', fontWeight: 600, wordBreak: 'break-all', minWidth: 160 }}>
                        {row.principal}
                        {row.isPrivileged && (
                          <span style={{ marginLeft: 6, fontSize: 9.5, fontWeight: 800, color: GOLD, border: `1px solid ${GOLD}55`, borderRadius: 999, padding: '1px 6px' }}>{uiText('generatedUi.u_9590fc1fa43e11e3')}</span>
                        )}
                      </td>
