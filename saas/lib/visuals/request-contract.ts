...
/**
 * Normalize every supported visual request envelope. The user-facing composers allow 8,000
 * characters, so the route must not retain the older 4,000-character private ceiling. Direct and
 * internal callers may send objective, prompt, input, or a normal messages array.
 */
