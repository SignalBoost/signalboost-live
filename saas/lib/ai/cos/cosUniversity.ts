...
const SUBJECT_RULES: ReadonlyArray<{ id: CosUniversitySubjectId; match: RegExp }> = [
  ...
  { id: 'physics_natural_sciences', match: /\b(physics|chemistry|biology|scientific method|mechanics?|gravity|optics?|semiconductors?|astronomy|astrophysics|space science|photonics?|natural sciences?|condensed matter|materials? science|materials? physics|materials? chemistry|materials? engineering|energy conservation|energy transfer|energy physics)\b/i },
  ...
  { id: 'economics_finance', match: /\b(economic(?:s|al|ally)?|finance|financial|accounting|investment|markets?|macroeconomic(?:s)?|microeconomic(?:s)?|portfolio|capital (?:markets?|allocation|expenditure|structure|budget(?:ing)?|gains?|raising|investment|efficiency|requirements?)|venture capital|working capital|cost of capital|capex|fiscal|monetary)\b/i },
