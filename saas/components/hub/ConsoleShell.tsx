...
const COMMAND_SECTIONS: CommandRailSection[] = [
  ...
  },
  {
    ...
    items: [
      { key: 'provider-1', icon: '🧱', label: 'Provider Page 1 — AWS', pageKey: 'providers' },
      { key: 'provider-2', icon: '🧠', label: 'Provider Page 2 — OpenAI + Anthropic', pageKey: 'providers' },
      { key: 'provider-3', icon: '🚀', label: 'Provider Page 3 — Supabase + Vercel', pageKey: 'providers' },
      { key: 'provider-4', icon: '🐙', label: 'Provider Page 4 — GitHub', pageKey: 'providers' },
      { key: 'provider-5', icon: '🏢', label: 'Provider Page 5 — GCP + Azure', pageKey: 'providers' },
      { key: 'provider-6', icon: '🌐', label: 'Provider Page 6 — Firebase + Cloudflare', pageKey: 'providers' },
      { key: 'provider-7', icon: '📱', label: 'Provider Page 7 — Twilio', pageKey: 'providers' },
      { key: 'provider-8', icon: '✉️', label: 'Provider Page 8 — SendGrid + Postmark', pageKey: 'providers' },
      { key: 'provider-9', icon: '🗄️', label: 'Provider Page 9 — MongoDB + DigitalOcean', pageKey: 'providers' },
      { key: 'provider-10', icon: '🔐', label: 'Provider Page 10 — Auth0', pageKey: 'providers' },
      { key: 'provider-11', icon: '🤖', label: 'Provider Page 11 — HF + Replicate', pageKey: 'providers' },
      { key: 'provider-12', icon: '🛠️', label: 'Provider Page 12 — Observability', pageKey: 'providers' },
      { key: 'provider-13', icon: '🚨', label: 'Provider Page 13 — Incident Ops', pageKey: 'providers' },
    ],
  },
  {
    title: 'Support',
