// saas/app/api/cos/script-worker/route.ts
// Single-item, instant draft worker (deterministic template). Used by the COS
// cockpit "Generate Draft" button. For multilingual, platform-aware, batch copy
