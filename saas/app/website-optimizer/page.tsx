...
const COPY: Record<Lang, Copy> = {
  en: { back: uiCopy('u_f84ebe5c8db93003'), badge: uiCopy('u_123671aca554dc11'), title: uiCopy('u_ae8074f0df9f6893'), subtitle: uiCopy('u_7475f39a4f3c4f0c'), urlLabel: uiCopy('u_a03dfbbad7be2f2d'), placeholder: uiCopy('u_499ba3291eda35c6'), scan: uiCopy('u_6c6e7b1f0debe647'), scanning: uiCopy('u_2f66cb428790e7d3'), hint: uiCopy('u_63cef3efa6c19139'), trySample: uiCopy('u_bdcf783a05a2f119'), missingUrl: uiCopy('u_1f719b0123058e0a'), scanFailed: uiCopy('u_a2acd93b1f376db7'), ready: uiCopy('u_39c63086c493dbe4'), begin: uiCopy('u_3b986445fd9a60ad'), score: uiCopy('u_54b813031e42b191'), loadTime: uiCopy('u_b44fb5402278e740'), findings: uiCopy('u_c22fbcc9187ed41a'), high: uiCopy('u_25065480229c97d8'), pageChecked: uiCopy('u_eb12da5d036d3e16'), topFindings: uiCopy('u_dc7439d12dfca893'), noFindings: uiCopy('u_69f6d86cc5c22290'), requestTitle: uiCopy('u_0f8fd974744fbe5b'), requestBody: uiCopy('u_0102460a6fb0514e'), requestCta: uiCopy('u_47402a954bf77245'), safeNote: uiCopy('u_86543a6a876b3c98'), categories: { performance: uiCopy('u_270ed7ebeef7d691'), seo: uiCopy('u_90564bc42e1800d6'), accessibility: uiCopy('u_dd292aaea875bb11'), security: uiCopy('u_9a0ff1f67befea8b'), conversion: uiCopy('u_459fcb8d11fe99e5') }, severities: { high: uiCopy('u_81697e05a81ae671'), medium: uiCopy('u_b187ed73858a2896'), low: uiCopy('u_f4744ce558f2f8b1') } },
