...
export const WORKSPACE_COPY: Record<string, FlatCopy> = {
  en: {
    ...
    'workspace.actions.unpublish': 'Unpublish',
    'workspace.actions.duplicate': 'Duplicate',
    'workspace.actions.preview': 'Preview',
    'workspace.actions.save': 'Save',
    'workspace.actions.cancel': 'Cancel',
    'workspace.actions.confirm': 'Confirm',
    'workspace.actions.close': 'Close',
    'workspace.actions.back': 'Back',
    'workspace.actions.next': 'Next',
    'workspace.actions.submit': 'Submit',
    'workspace.actions.reset': 'Reset',
    'workspace.actions.generate': 'Generate',
    'workspace.actions.download': 'Download',
    ...
    'workspace.error.limitReached': 'You have reached your plan limit. Upgrade to continue.',
    'workspace.error.saveFailed': 'Could not save changes. Please try again.',
    'workspace.success.saved': 'Changes saved.',
    'workspace.success.published': 'Published successfully.',
    'workspace.success.deleted': 'Deleted successfully.',
    'workspace.success.copied': 'Link copied to clipboard.',
  },
  ...
  pt: {
    ...
    'workspace.actions.delete': 'Excluir',
    'workspace.actions.publish': 'Publicar',
    'workspace.actions.unpublish': 'Despublicar',
    'workspace.actions.duplicate': 'Duplicar',
    'workspace.actions.preview': 'Pré-visualizar',
    'workspace.actions.save': 'Salvar',
    'workspace.actions.cancel': 'Cancelar',
    'workspace.actions.confirm': 'Confirmar',
    'workspace.actions.close': 'Fechar',
    'workspace.actions.back': 'Voltar',
    'workspace.actions.next': 'Próximo',
    'workspace.actions.submit': 'Enviar',
    'workspace.actions.reset': 'Redefinir',
    'workspace.actions.generate': 'Gerar',
    'workspace.actions.download': 'Baixar',
    ...
    'workspace.status.archived': 'Arquivado',
    ...
    'workspace.error.limitReached': 'Você atingiu o limite do seu plano. Faça upgrade para continuar.',
    'workspace.error.saveFailed': 'Não foi possível salvar as alterações. Tente novamente.',
    'workspace.success.saved': 'Alterações salvas.',
    'workspace.success.published': 'Publicado com sucesso.',
    'workspace.success.deleted': 'Excluído com sucesso.',
    'workspace.success.copied': 'Link copiado para a área de transferência.',
  },
  ...
  es: {
    ...
    'workspace.actions.open': 'Abrir',
    'workspace.actions.edit': 'Editar',
    'workspace.actions.delete': 'Eliminar',
    'workspace.actions.publish': 'Publicar',
    'workspace.actions.unpublish': 'Despublicar',
    'workspace.actions.duplicate': 'Duplicar',
    'workspace.actions.preview': 'Vista previa',
    'workspace.actions.save': 'Guardar',
    'workspace.actions.cancel': 'Cancelar',
    'workspace.actions.confirm': 'Confirmar',
    'workspace.actions.close': 'Cerrar',
    'workspace.actions.back': 'Volver',
    'workspace.actions.next': 'Siguiente',
    'workspace.actions.submit': 'Enviar',
    'workspace.actions.reset': 'Restablecer',
    'workspace.actions.generate': 'Generar',
    'workspace.actions.download': 'Descargar',
    ...
    'workspace.error.limitReached': 'Has alcanzado el límite de tu plan. Actualiza para continuar.',
    'workspace.error.saveFailed': 'No se pudieron guardar los cambios. Inténtalo de nuevo.',
    'workspace.success.saved': 'Cambios guardados.',
    'workspace.success.published': 'Publicado correctamente.',
    'workspace.success.deleted': 'Eliminado correctamente.',
    'workspace.success.copied': 'Enlace copiado al portapapeles.',
  },
  ...
  pl: {
    ...
    'workspace.actions.delete': 'Usuń',
    'workspace.actions.publish': 'Opublikuj',
    'workspace.actions.unpublish': 'Cofnij publikację',
    'workspace.actions.duplicate': 'Duplikuj',
    'workspace.actions.preview': 'Podgląd',
    'workspace.actions.save': 'Zapisz',
    'workspace.actions.cancel': 'Anuluj',
    'workspace.actions.confirm': 'Potwierdź',
    'workspace.actions.close': 'Zamknij',
    'workspace.actions.back': 'Wstecz',
    'workspace.actions.next': 'Dalej',
    'workspace.actions.submit': 'Wyślij',
    'workspace.actions.reset': 'Resetuj',
    'workspace.actions.generate': 'Generuj',
    'workspace.actions.download': 'Pobierz',
    ...
    'workspace.status.archived': 'Zarchiwizowany',
    ...
    'workspace.error.limitReached': 'Osiągnięto limit planu. Ulepsz plan, aby kontynuować.',
    'workspace.error.saveFailed': 'Nie udało się zapisać zmian. Spróbuj ponownie.',
    'workspace.success.saved': 'Zmiany zapisane.',
    'workspace.success.published': 'Opublikowano pomyślnie.',
    'workspace.success.deleted': 'Usunięto pomyślnie.',
    'workspace.success.copied': 'Link skopiowany do schowka.',
  },
  ...
  ru: {
    ...
    'workspace.actions.delete': 'Удалить',
    'workspace.actions.publish': 'Опубликовать',
    'workspace.actions.unpublish': 'Снять с публикации',
    'workspace.actions.duplicate': 'Дублировать',
    'workspace.actions.preview': 'Предпросмотр',
    'workspace.actions.save': 'Сохранить',
    'workspace.actions.cancel': 'Отмена',
    'workspace.actions.confirm': 'Подтвердить',
    'workspace.actions.close': 'Закрыть',
    'workspace.actions.back': 'Назад',
    'workspace.actions.next': 'Далее',
    'workspace.actions.submit': 'Отправить',
    'workspace.actions.reset': 'Сбросить',
    'workspace.actions.generate': 'Генерировать',
    'workspace.actions.download': 'Скачать',
    ...
    'workspace.status.archived': 'В архиве',
    ...
    'workspace.error.limitReached': 'Достигнут лимит плана. Улучшите план, чтобы продолжить.',
    'workspace.error.saveFailed': 'Не удалось сохранить изменения. Попробуйте ещё раз.',
    'workspace.success.saved': 'Изменения сохранены.',
    'workspace.success.published': 'Успешно опубликовано.',
    'workspace.success.deleted': 'Успешно удалено.',
    'workspace.success.copied': 'Ссылка скопирована в буфер обмена.',
  },
}
