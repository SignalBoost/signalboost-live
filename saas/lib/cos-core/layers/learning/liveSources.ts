...
/**
 * Production bindings for already-approved public knowledge sources.
 * They are independently opt-in and use small result caps so enabling autonomous learning
 * does not silently turn one knowledge gap into an unbounded crawl.
 */
