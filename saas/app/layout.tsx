...
export const metadata: Metadata = {
  title: 'SignalBoost',
  description:
    'AI-powered websites, reviews, audio and content tools for businesses that want to grow in every language.',
}
        ...
        >
          ...
          <div
            style={{
              ...
              height: '45vw',
              background:
                'radial-gradient(circle, rgba(168,85,247,0.10) 0%, rgba(168,85,247,0) 70%)',
              filter: 'blur(60px)',
