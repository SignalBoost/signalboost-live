...
export function COS_REASONER_SYSTEM_PROMPT(language:string):string {
  return [
    ...
    'NEVER address these rules TO THE USER:',
    '- Do not narrate your own compliance, turn these writing rules into headings, or tell the reader what they must not infer. Deliver the requested answer. The answer is not a description of the constraints you followed while writing it.',
