  ...
  return (
    <main className="min-h-screen bg-black text-white p-8">
      <header className="flex flex-wrap items-center justify-between gap-4 mb-16">
        ...
        <AdminNavLink className="rounded-full border border-emerald-300/40 px-4 py-2 text-sm font-bold text-emerald-200 no-underline hover:bg-emerald-300 hover:text-black">Admin</AdminNavLink>
