-- Qualify table columns that collide with RETURNS TABLE output names in PL/pgSQL.
...
begin
  ...
  where public.cos_university_one_time_dataset_preparation_approvals.token_hash = p_token_hash
    and public.cos_university_one_time_dataset_preparation_approvals.status = 'pending'
    and public.cos_university_one_time_dataset_preparation_approvals.subject_id = 'reasoning_decision_science'
    and public.cos_university_one_time_dataset_preparation_approvals.operation = 'prepare_dataset'
    and public.cos_university_one_time_dataset_preparation_approvals.student_training_authorized = false
    and public.cos_university_one_time_dataset_preparation_approvals.authority_expanded = false
    and public.cos_university_one_time_dataset_preparation_approvals.authorized_at <= v_now + interval '60 seconds'
    and public.cos_university_one_time_dataset_preparation_approvals.expires_at > v_now
    and public.cos_university_one_time_dataset_preparation_approvals.expires_at <= public.cos_university_one_time_dataset_preparation_approvals.authorized_at + interval '15 minutes'
    and public.cos_university_one_time_dataset_preparation_approvals.max_hourly_cost_usd > 0
    and public.cos_university_one_time_dataset_preparation_approvals.max_hourly_cost_usd <= 0.050000
    and public.cos_university_one_time_dataset_preparation_approvals.max_estimated_cost_usd > 0
    and public.cos_university_one_time_dataset_preparation_approvals.max_estimated_cost_usd <= 0.015000
...
begin
  ...
  where public.cos_university_one_time_dataset_preparation_approvals.token_hash = p_token_hash
    and public.cos_university_one_time_dataset_preparation_approvals.status = 'claimed'
    and public.cos_university_one_time_dataset_preparation_approvals.claimed_at = p_claimed_at
  returning * into v_row;
