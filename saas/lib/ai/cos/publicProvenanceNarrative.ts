...
export function acceptPublicNarrative(candidate: string | null | undefined, facts: PublicProvenanceFacts): string | null {
  ...
  // Owner correction (2026-08-25, observed in production): report-style third-person
  // self-narration ("The previous answer was generated by COS…") is rejected so the retry runs
  // with the first-person instruction. English-pattern check only — a heuristic nudge, not a
  // grammar police; other languages rely on the instruction.
