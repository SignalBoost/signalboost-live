    ...
    setMessages([
      {
        role: 'assistant',
        content:
          `${dict.builderGreat || 'Great'}${userName ? ' ' + userName : ''}! ` +
          `${dict.builderStarting || 'I am building your website for'} "${businessName}" ` +
          `${dict.builderLanguageCount || 'in'} ${languages.length} ` +
          `${languages.length > 1 ? dict.languages || 'languages' : dict.language || 'language'}.\n\n` +
          `${dict.builderCreating || 'Here is what I am creating'}:\n\n` +
          `✓ ${dict.homepageBusinessInfo || 'Homepage with your business info'}\n` +
          `✓ ${dict.aboutSection || 'About section'}\n` +
          `✓ ${dict.contactDetails || 'Contact details'}\n` +
          `✓ ${languages.length > 1 ? dict.multilingualContent || 'Content in multiple languages' : dict.englishContent || 'English content'}\n\n` +
          `${dict.builderMoreDetails || 'Tell me more about your business — the more details you give me, the better your site will be.'}`,
      },
    ])
  }
    ...
    <div style={{ color: 'var(--text-primary)', fontFamily: 'system-ui' }}>
      ...
      >
        <div>
          ...
          >
            🌐 {dict.buildWebsite || 'Site builder'}
          </h1>
      ...
      {step === 'template' && (
        <div style={{ animation: 'fadeIn 0.3s ease-out' }}>
          <h2 style={{ fontSize: 18, fontWeight: 700, marginBottom: 8 }}>
            {dict.siteTypeQuestion || 'What kind of site do you need?'}
          </h2>
          ...
          >
            {dict.chooseStartingPoint ||
              'Choose a starting point — you can customize everything after.'}
          </p>
      ...
      {step === 'info' && (
        <div style={{ maxWidth: 560, animation: 'fadeIn 0.3s ease-out' }}>
          <h2 style={{ fontSize: 18, fontWeight: 700, marginBottom: 8 }}>
            {dict.tellBusiness || 'Tell me about your business'}
          </h2>
          ...
          >
            {dict.aiWillGenerate ||
              'The AI will use this to generate your entire site automatically.'}
          </p>
          ...
          >
            <div>
              ...
              >
                {dict.businessName || 'Business name'} *
              </label>

              <input
                value={businessName}
                onChange={e => setBusinessName(e.target.value)}
                placeholder={dict.businessNameExample || "e.g. Maria's Bakery"}
                style={{
                  width: '100%',
                  padding: '12px 14px',
                  borderRadius: 10,
            ...
            <div>
              ...
              >
                {dict.describeBusiness || 'Describe your business'}
              </label>
              ...
              <textarea
                ...
                placeholder={
                  dict.businessDescriptionExample ||
      ...
      {step === 'languages' && (
        <div style={{ maxWidth: 560, animation: 'fadeIn 0.3s ease-out' }}>
          <h2 style={{ fontSize: 18, fontWeight: 700, marginBottom: 8 }}>
            {dict.whichLanguages || 'Which languages do you need?'}
          </h2>

          <p style={{ fontSize: 13, color: 'var(--text-muted)', marginBottom: 24 }}>
            {dict.nativeContent ||
              'Your site will be available in all selected languages with native content.'}
          </p>
          ...
          <div style={{ fontSize: 12, color: 'var(--text-faint)', marginBottom: 24 }}>
            {languages.length === 1
              ? dict.freePlanOneLanguage || 'Free plan: 1 language included'
              : `${languages.length} ${dict.languagesSelected || 'languages selected — requires Starter plan or above'}`}
          </div>
          ...
          <div style={{ display: 'flex', gap: 12 }}>
            ...
            >
              {dict.buildMySite || 'Build my site'} →
            </button>
          </div>
        </div>
      )}
            ...
            >
              ...
              >
                ...
                <span style={{ fontSize: 13, fontWeight: 700 }}>
                  {dict.aiBuilderAssistant || 'AI Builder Assistant'}
                </span>
              </div>
              ...
              >
                <input
                  ...
                  placeholder={dict.tellMeMore || 'Tell me more about your business...'}
                  style={{
                    flex: 1,
                    padding: '9px 12px',
                    borderRadius: 8,
