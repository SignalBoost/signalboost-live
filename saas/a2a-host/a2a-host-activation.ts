...
export const A2A_HOST_ACTIVATION_VERSION = 'signalboost-a2a-host-activation-v2' as const
...
/**
 * Production composition root: specialist qualification and routing telemetry come from service-role
 * durable evidence. Callers cannot silently replace these ports with Agent Card or assignment metadata.
 */
