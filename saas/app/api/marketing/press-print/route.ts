...
export async function POST(req: NextRequest) {
  ...
  return NextResponse.json({ ok: true, campaign: data, previewEmail, releaseStatus: release.status, releaseGenerated: Boolean(release.body), approvalRef: (row.metadata as any).approval_ref })
}
