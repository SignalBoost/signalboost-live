...
const SECTION_DEFS = [
  ...
  },
  {
    ...
    items: [
      { qKey: 'docs.pricing.q1', qFallback: 'What are the plan limits?', aKey: 'docs.pricing.a1', aFallback: 'Free: 1 project, 1 language, preview only with watermark, limited AI credits. Starter ($15/mo): 1 published website, 2 languages, ~50 audio generations/month. Pro ($39/mo): 5 websites, all 5 languages, ~200 audio generations/month, video tools. Business ($99/mo): unlimited websites, all languages plus custom, white label. Podcast plans are separate — see the Podcasters page for details.' },
