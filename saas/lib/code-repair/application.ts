...
export class CodeRepairApplicationOrchestrator {
  ...
  constructor(approvals: CodeRepairApprovalService, workspaces: CodeRepairDisposableWorkspaceManager, audit: CodeRepairExecutionAuditSink = new InMemoryCodeRepairExecutionAuditSink(), metrics = new CodeRepairExecutionMetricsCollector()) { this.approvals = approvals; this.workspaces = workspaces; this.audit = audit; this.metrics = metrics;}
