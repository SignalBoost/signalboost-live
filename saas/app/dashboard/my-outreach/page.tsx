...
const COPY = {
  eyebrow:     { en: uiText('generatedUi.u_b97dc5270c1705f5'), es: 'Crecer', pt: 'Crescer', pl: 'Rozwój', ru: 'Рост' },
  title:       { en: uiText('generatedUi.u_04c411dc1ee0d29f'), es: 'Mi prospección', pt: 'Minha prospecção', pl: 'Mój outreach', ru: 'Мой аутрич' },
  subtitle:    { en: uiText('generatedUi.u_722149143a688b7e'), es: 'Crea mensajes de prospección de calidad IA para tu negocio, revísalos y envíalos desde tu propio correo.', pt: 'Crie mensagens de prospecção com qualidade de IA para o seu negócio, revise e envie do seu próprio e-mail.', pl: 'Twórz wiadomości outreach jakości AI dla swojej firmy, sprawdzaj je i wysyłaj z własnej poczty.', ru: 'Создавайте аутрич-сообщения уровня ИИ для вашего бизнеса, проверяйте и отправляйте со своей почты.' },
  tip:         { en: uiText('generatedUi.u_9455a2506cbad568'), es: '💡 Consejo: pide al Concierge que escriba borradores — p. ej. "Redacta un mensaje de prospección a un hotel local para mi negocio".', pt: '💡 Dica: peça ao Concierge para escrever rascunhos — ex. "Redija uma mensagem de prospecção para um hotel local para o meu negócio".', pl: '💡 Wskazówka: poproś Concierge o napisanie szkiców — np. "Napisz wiadomość outreach do lokalnego hotelu dla mojej firmy".', ru: '💡 Совет: попросите Консьержа написать черновики — напр. «Составь аутрич-сообщение местному отелю для моего бизнеса».' },
  upgradeTitle:{ en: uiText('generatedUi.u_417cb998be01d968'), es: 'La prospección es una función de Growth y Command', pt: 'A prospecção é um recurso dos planos Growth e Command', pl: 'Outreach to funkcja planów Growth i Command', ru: 'Аутрич доступен на планах Growth и Command' },
  upgradeBody: { en: uiText('generatedUi.u_79352022ab344a76'), es: 'Mejora tu plan para que la IA de SignalBoost escriba, gestione y haga seguimiento de tu prospección.', pt: 'Faça upgrade do plano para que a IA do SignalBoost escreva, gerencie e acompanhe sua prospecção.', pl: 'Ulepsz plan, aby AI SignalBoost pisała, zarządzała i śledziła Twój outreach.', ru: 'Обновите план, чтобы ИИ SignalBoost писал, управлял и отслеживал ваш аутрич.' },
  upgradeCta:  { en: uiText('generatedUi.u_a72e2bd3e148c05e'), es: 'Ver planes', pt: 'Ver planos', pl: 'Zobacz plany', ru: 'Смотреть планы' },
  newDraft:    { en: uiText('generatedUi.u_1f2c17331a7383f3'), es: 'Nuevo borrador', pt: 'Novo rascunho', pl: 'Nowy szkic', ru: 'Новый черновик' },
  bizName:     { en: uiText('generatedUi.u_f3869bb155251d39'), es: 'Nombre del negocio objetivo', pt: 'Nome do negócio-alvo', pl: 'Nazwa firmy docelowej', ru: 'Название целевой компании' },
  bizUrl:      { en: uiText('generatedUi.u_a3ed39057034ba7d'), es: 'Sitio web objetivo (https://…)', pt: 'Site-alvo (https://…)', pl: 'Strona docelowa (https://…)', ru: 'Сайт цели (https://…)' },
  message:     { en: uiText('generatedUi.u_00b8561daef5fc2a'), es: 'Tu mensaje (40–2.400 caracteres)', pt: 'Sua mensagem (40–2.400 caracteres)', pl: 'Twoja wiadomość (40–2400 znaków)', ru: 'Ваше сообщение (40–2400 символов)' },
  create:      { en: uiText('generatedUi.u_07d07af207607fd0'), es: 'Crear borrador', pt: 'Criar rascunho', pl: 'Utwórz szkic', ru: 'Создать черновик' },
  creating:    { en: uiText('generatedUi.u_c79ed9492e3c1719'), es: 'Creando…', pt: 'Criando…', pl: 'Tworzenie…', ru: 'Создание…' },
  empty:       { en: uiText('generatedUi.u_39df5c2fbe55f5cf'), es: 'Aún no hay borradores. Crea uno abajo o pide al Concierge.', pt: 'Ainda não há rascunhos. Crie um abaixo ou peça ao Concierge.', pl: 'Brak szkiców. Utwórz poniżej lub poproś Concierge.', ru: 'Черновиков пока нет. Создайте ниже или попросите Консьержа.' },
  approve:     { en: uiText('generatedUi.u_6007acbe30b2cd98'), es: 'Aprobar', pt: 'Aprovar', pl: 'Zatwierdź', ru: 'Одобрить' },
  reject:      { en: uiText('generatedUi.u_ab604a360777735f'), es: 'Rechazar', pt: 'Rejeitar', pl: 'Odrzuć', ru: 'Отклонить' },
  openEmail:   { en: uiText('generatedUi.u_8c8b417f26b87ee8'), es: '✉️ Abrir en tu correo', pt: '✉️ Abrir no e-mail', pl: '✉️ Otwórz w poczcie', ru: '✉️ Открыть в почте' },
  copyMsg:     { en: uiText('generatedUi.u_51be5db87b562ccd'), es: '📋 Copiar mensaje', pt: '📋 Copiar mensagem', pl: '📋 Kopiuj wiadomość', ru: '📋 Копировать' },
  copied:      { en: uiText('generatedUi.u_ea61bc15688d1e48'), es: '¡Copiado!', pt: 'Copiado!', pl: 'Skopiowano!', ru: 'Скопировано!' },
  usage:       { en: uiText('generatedUi.u_ebfe4c0262bfe7bb'), es: 'borradores hoy', pt: 'rascunhos hoje', pl: 'szkice dzisiaj', ru: 'черновиков сегодня' },
  loadError:   { en: uiText('generatedUi.u_0321e8bb7664807f'), es: 'No se pudieron cargar tus borradores.', pt: 'Não foi possível carregar seus rascunhos.', pl: 'Nie udało się załadować szkiców.', ru: 'Не удалось загрузить черновики.' },
  statuses: {
    pending:  { en: uiText('generatedUi.u_331551b0de4157c9'),  es: 'Pendiente', pt: 'Pendente', pl: 'Oczekuje', ru: 'Ожидает' },
    approved: { en: uiText('generatedUi.u_87b42e40c2a290e0'), es: 'Aprobado',  pt: 'Aprovado', pl: 'Zatwierdzony', ru: 'Одобрен' },
    rejected: { en: uiText('generatedUi.u_aea4a04a80426ed8'), es: 'Rechazado', pt: 'Rejeitado', pl: 'Odrzucony', ru: 'Отклонён' },
  },
}
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', gap: 10, flexWrap: 'wrap', alignItems: 'flex-start' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexWrap: 'wrap', justifyContent: 'flex-end' }}>
                  {d.source_platform === 'concierge' ? (
                    <span style={{ fontSize: 10.5, fontWeight: 800, color: '#c4b5fd', border: '1px solid rgba(196,181,253,.5)', borderRadius: 999, padding: '3px 9px' }}>{uiText('generatedUi.u_72d4bf2725543fcf')}</span>
                  ) : null}
