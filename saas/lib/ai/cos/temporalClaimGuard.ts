...
const LATEST_STATE = /\b(?:latest|newest|most\s+recent|current)\s+(?:version|release|model|price|pricing|edition|status|availability|schedule|ranking|rate|guidance|policy|plan|specification|specifications)\b/i
