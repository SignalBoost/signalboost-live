// saas/lib/browser-runtime/error-sanitizer.ts
//
// SHIM. The real module now lives in the portable at
// lib/portable-browser/browser-error-sanitizer.ts, because four shipped adapters on the buyer
...
export * from '../portable-browser/browser-error-sanitizer.ts'
