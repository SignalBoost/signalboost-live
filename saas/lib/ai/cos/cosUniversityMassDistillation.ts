...
/**
 * Deterministically package source identities by subject. No source text enters this function or the
 * queue. A short tail stays unassigned until enough additional rights-cleared learning arrives.
 */
...
/**
 * Non-spending University packaging sweep. It reads rights/provenance identities only, never source
 * text, and can only create dispatch_authorized=false curriculum rows. Teacher/training jobs require a
 * separate owner-governed budget/approval surface.
 */
