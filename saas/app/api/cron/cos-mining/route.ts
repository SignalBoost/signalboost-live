...
export async function GET(req: NextRequest) {
  ...
  if (job === 'daily') {
    ...
    // Active cognitive practice is deliberately batched into the existing daily COS job so it
    // does not create another scheduled Vercel invocation. It is bounded internally and never
    // counts locally generated exercises as held-out validation.
    try {
