...
const COPY: Record<string, Record<string, string>> = {
  en: { title: uiCopy('u_22922f90961919cf'), apiKey: uiCopy('u_ef4c04dfd06fce6b'), brand: uiCopy('u_cb207af0320722a1'), endpoint: uiCopy('u_8729f7838ec183af'), report: uiCopy('u_61db3c0bbb715cd5'), price: uiCopy('u_fda6fc1dd55e6f12'), currency: uiCopy('u_dc70783c1843ff53'), advanced: uiCopy('u_aa2b46e3cffad64e'), payload: uiCopy('u_c87508b930790383'), refPath: uiCopy('u_4a9cf9fac743a403'), connect: uiCopy('u_d20231576b733c7c'), connecting: uiCopy('u_34c3fe744bf18c93'), connected: uiCopy('u_466aee85c9fd70a0'), perRelease: uiCopy('u_8771fdc8159eb439'), disconnect: uiCopy('u_eee389be185cf3c7'), disconnecting: uiCopy('u_2f3fbc0acb9698a7'), keyNote: uiCopy('u_b9a61029ef7acac4'), done: uiCopy('u_2d6f830200b35ffe'), errGeneric: uiCopy('u_794c9ce4ced46b9c'), errOwner: uiCopy('u_b518034aeeff8990'), errKey: uiCopy('u_4702210f25933023'), errEndpoint: uiCopy('u_d69202432aad4215'), errTemplate: uiCopy('u_e1db5bc515e585b1') },
