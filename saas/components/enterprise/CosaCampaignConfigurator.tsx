  ...
  return <form onSubmit={submit} style={{ display: 'grid', gap: 14, marginTop: 16 }}>
    ...
    <div style={{ display: 'flex', justifyContent: 'flex-end' }}>
      <button
        ...
        style={{ border: 'none', background: '#ffc300', color: '#000', borderRadius: 12, padding: '10px 14px', fontWeight: 900, cursor: busy || analyzing ? 'wait' : 'pointer', opacity: busy || analyzing || !ready ? .55 : 1 }}
      >
