...
const COPY: Record<Lang, Copy> = {
  en: { back: 'SignalBoost', badge: 'Free cybersecurity preview', title: 'Check public website security signals for free.', subtitle: 'Paste a public website URL and get a safe preview of HTTPS, security headers, cookie flags, mixed-content signals, and public exposure indicators.', urlLabel: 'Public website URL', placeholder: 'https://example.com', scan: 'Run cybersecurity preview', scanning: 'Checking…', hint: 'Public page only. No port scanning, exploit testing, private login, crawling, or automatic changes.', trySample: 'Try SignalBoost', missingUrl: 'Paste a public website URL first.', scanFailed: 'Could not check this website.', ready: 'Ready', begin: 'Paste a website URL to begin', score: 'Score', response: 'Response', findings: 'Findings', high: 'High', pageChecked: 'Page checked', topFindings: 'Top security signals', noFindings: 'No major public security signals were flagged in this preview. This is not a full security audit, but it is a useful first check.', signals: 'Observed signals', requestTitle: 'Request a security plan', requestBody: 'Send this result to the COS Marketing + Sales engine. It will create a tagged cybersecurity lead and prepare an owner-approved follow-up plan. Nothing sends automatically.', requestCta: 'Request security plan', safeNote: 'No testing or follow-up happens without approval.', categories: { transport: 'Transport', headers: 'Headers', cookies: 'Cookies', content: 'Content', exposure: 'Exposure' }, severities: { high: 'High', medium: 'Medium', low: 'Low' } },
