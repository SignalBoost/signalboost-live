...
export { createAdPlatformAdapter } from './adapters/ad-platform'
export { createDirectIoAdapter } from './adapters/direct-io'
export { createMediaDatabaseAdapter, verifyTargetAgainstDatabase } from './adapters/media-database'
