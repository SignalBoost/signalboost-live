...
const COPY: Record<string, Record<Lang, string>> = {
  ...
  futureNote:   { en: 'The grid scales automatically — each new provider is one panel. Planned for the AI expansion phase.', es: 'La cuadrícula escala automáticamente — cada nuevo proveedor es un panel. Planificado para la fase de expansión de IA.', pt: 'A grade escala automaticamente — cada novo provedor é um painel. Planejado para a fase de expansão de IA.', pl: 'Siatka skaluje się automatycznie — każdy nowy dostawca to jeden panel. Zaplanowane na fazę ekspansji AI.', ru: 'Сетка масштабируется автоматически — каждый новый провайдер это одна панель. Запланировано на фазу расширения ИИ.' },
}
