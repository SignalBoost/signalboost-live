...
import { setElevenLabsRateCentsPer1k } from '@/render-core/executors/elevenlabs-voice'
...
// ElevenLabs pricing is a SignalBoost deployment fact, not a render-core concern.
// Reading it here keeps render-core env-free (host-agnostic core, coupling in host).
const ELEVENLABS_CENTS_PER_1K_CHARS = Number(process.env.ELEVENLABS_CENTS_PER_1K_CHARS || '18')
...
export function createSignalBoostRenderHost(): RenderHost {
  setElevenLabsRateCentsPer1k(ELEVENLABS_CENTS_PER_1K_CHARS)
  return {
