  ...
  return (
    <main className="sb-hmi-shell">
      <section className="sb-hmi-hero" aria-labelledby="module-title">
        ...
        <h1 id="module-title">📅 Calendar</h1>
        <p>Plan month-view operations, event creation overlays, and reminder telemetry before production build.</p>
      ...
      <section className="sb-hmi-module" style={{ marginTop: 24 }} tabIndex={0}>
        <div className="sb-hmi-module__top">
          ...
          <div>
            ...
            <h2>Calendar cockpit layout</h2>
          </div>
          <strong>01</strong>
        </div>
        <div className="sb-hmi-module__grid">
          <div className="sb-hmi-panel sb-hmi-panel--primary"><span>Monthly view grid</span><div className="sb-hmi-form-lines"><i /><i /><i /></div></div>
          <div className="sb-hmi-panel"><span>Event creation modal</span><div className="sb-hmi-chart"><span style={{ height: '36%', background: 'linear-gradient(180deg, #1af0ff, rgba(26,240,255,.18))' }} /><span style={{ height: '70%', background: 'linear-gradient(180deg, #1af0ff, rgba(26,240,255,.18))' }} /><span style={{ height: '52%', background: 'linear-gradient(180deg, #1af0ff, rgba(26,240,255,.18))' }} /><span style={{ height: '86%', background: 'linear-gradient(180deg, #1af0ff, rgba(26,240,255,.18))' }} /></div></div>
          <div className="sb-hmi-panel"><span>Reminder timeline strip</span><div className="sb-hmi-feed"><i /><i /><i /></div></div>
        </div>
      </section>
    </main>
  )
