...
const COPY: Record<string, Record<string, string>> = {
  en: { title: uiCopy('u_58e29f03b1b0f09b'), why: uiCopy('u_b095556ba3d32f42'), brand: uiCopy('u_c866e513bf6a4e83'), website: uiCopy('u_6c00cc8c31ff824d'), products: uiCopy('u_ce4bda742bcea6f3'), save: uiCopy('u_8e602d04ab687c1c'), saving: uiCopy('u_57d7d542c9961e0e'), saved: uiCopy('u_56a67e979bf08951'), later: uiCopy('u_a0074878d6f4b8c5'), err: uiCopy('u_29341864935745e4'), need: uiCopy('u_5a5b1fafe343fdb6'), using: uiCopy('u_8b5e1e27d396a004') },
