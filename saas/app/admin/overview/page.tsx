...
const COPY = {
  en: { eyebrow: uiCopy('u_a9b073518fbeba78'), title: uiCopy('u_392a02a15d489e60'), refresh: uiCopy('u_9db120e9ac78246f'), refreshing: uiCopy('u_e06f83682b952a02'), loading: uiCopy('u_e295bf8b0b5b56cf'), accounts: uiCopy('u_828fb72e0cbdf289'), registeredUsers: uiCopy('u_fc531cf59e0e8a65'), teamMembers: uiCopy('u_ef91641960b6e4d5'), subscriptions: uiCopy('u_1c034dacbd039f15'), planDist: uiCopy('u_057aae4ebd6884e2'), contentActivity: uiCopy('u_7a4a331292f83477'), reviews: uiCopy('u_db7a0df4686d8be8'), approved: uiCopy('u_3e03e7bfb4ea7d28'), campaigns: uiCopy('u_4368f83c341a0ccd'), active: uiCopy('u_22c220c6c537a254'), sitesBuilt: uiCopy('u_8a8769e1794dcfb9'), published: uiCopy('u_604cd47ca829ef00'), outreachLeads: uiCopy('u_94aadd73e3df9923'), liveStatus: uiCopy('u_1da090dd146d8220'), liveStatusBody: uiCopy('u_8502cca609d364e4'), generated: uiCopy('u_6dca65eba79ba1fe'), errorDefault: uiCopy('u_69f033127a314bd2'), errorGeneric: uiCopy('u_867720c2da7c9c90') },
