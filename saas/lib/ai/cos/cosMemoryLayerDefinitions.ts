...
// Owner-approved company-identity fact (2026-08-24). Kept as a fixed, deterministic definition —
// never model-guessed — for the same reason ownership stays out of this description: it is not
// COS's place to invent or infer who owns SignalBoost, only to state the one sentence the owner
// has authorized for this exact question.
