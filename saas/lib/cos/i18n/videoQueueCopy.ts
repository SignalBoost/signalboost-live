...
const en: VideoQueueCopy = {
  ...
  metricNeeds: 'Need approval',
  metricProgress: 'In progress',
  metricPublished: 'Published',
  bucketNeeds: 'Needs your approval',
  bucketProgress: 'In progress — no action needed',
  bucketPublished: 'Published',
  empty: 'Nothing here right now.',
  preview: 'Preview',
  reject: 'Reject',
  approve: 'Approve',
  approveRender: 'Approve for rendering',
...
const es: VideoQueueCopy = {
  ...en,
  eyebrow: 'Cola de revisión de video COSA', headline: 'COSA prepara. Tú apruebas.', intro: 'Haz clic en Vista previa y luego usa Reproducir vista previa en el panel derecho. Es un borrador renderizado en el navegador; el MP4 final es la siguiente etapa.', metricNeeds: 'Necesitan aprobación', metricProgress: 'En progreso', metricPublished: 'Publicados', bucketNeeds: 'Necesitan tu aprobación', bucketProgress: 'En progreso — no requiere acción', bucketPublished: 'Publicados', empty: 'No hay nada aquí ahora.', preview: 'Vista previa', reject: 'Rechazar', approve: 'Aprobar', approveRender: 'Aprobar para renderizar', playablePreview: 'Vista previa reproducible', hookLabel: 'Gancho', nicheLabel: 'nicho', formatLabel: 'formato', heroLabel: 'héroe', qualityLabel: 'calidad', statusNeeds: 'Esperando aprobación', statusProgress: 'En progreso', statusPublished: 'Publicado', statusRejected: 'Rechazado', playPreview: 'Reproducir vista previa', pausePreview: 'Pausar vista previa', nextScene: 'Siguiente escena', sceneLabel: 'Escena',
  items: [
...
const pt: VideoQueueCopy = {
  ...en,
  eyebrow: 'Fila de revisão de vídeo COSA', headline: 'COSA prepara. Você aprova.', intro: 'Clique em Prévia e depois use Reproduzir prévia no painel direito. Este é um rascunho renderizado no navegador; o MP4 final é a próxima etapa.', metricNeeds: 'Precisam de aprovação', metricProgress: 'Em progresso', metricPublished: 'Publicados', bucketNeeds: 'Precisam da sua aprovação', bucketProgress: 'Em progresso — sem ação necessária', bucketPublished: 'Publicados', empty: 'Nada aqui no momento.', preview: 'Prévia', reject: 'Rejeitar', approve: 'Aprovar', approveRender: 'Aprovar para renderizar', playablePreview: 'Prévia reproduzível', hookLabel: 'Gancho', nicheLabel: 'nicho', formatLabel: 'formato', heroLabel: 'herói', qualityLabel: 'qualidade', statusNeeds: 'Aguardando aprovação', statusProgress: 'Em progresso', statusPublished: 'Publicado', statusRejected: 'Rejeitado', playPreview: 'Reproduzir prévia', pausePreview: 'Pausar prévia', nextScene: 'Próxima cena', sceneLabel: 'Cena',
  items: [
