...
/**
 * Turns durable, objective repair outcomes into bounded diagnostic context. A past success is not
 * approval and cannot widen Agent Gateway policy. Any recorded failure disqualifies the action.
 */
