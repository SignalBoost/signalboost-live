...
type Result = { url: string; finalUrl: string; score: number; checks: Check[]; summary: string; source: string }
  ...
  return (
    <main style={{ padding: 24, color: '#fff', maxWidth: 920, margin: '0 auto' }}>
      ...
      <p className="sb-body" style={{ maxWidth: 680 }}>
        {t(dict, 'services.improve.desc', 'Audit any URL for SEO, speed, conversion, and accessibility — and get a prioritized action plan.')}
      </p>
      ...
      {loading && <p className="sb-body" style={{ marginTop: 16 }}>Fetching the page and running checks…</p>}
        ...
        <div style={{ marginTop: 24, display: 'grid', gap: 20 }}>
          ...
          <section className="sb-card" style={{ padding: 22, display: 'grid', gridTemplateColumns: 'auto 1fr', gap: 22, alignItems: 'center' }}>
            ...
            <div style={{ minWidth: 0 }}>
              <div className="sb-caption" style={{ marginBottom: 6, wordBreak: 'break-all' }}>{result.finalUrl}</div>
