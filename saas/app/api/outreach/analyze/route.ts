...
import type { OutreachCategory } from '@/lib/ai/outreachMessage'

export const dynamic = 'force-dynamic'

const VALID_CATEGORIES: OutreachCategory[] = ['affiliate', 'company', 'media']
...
export async function POST(req: NextRequest) {
  ...
  const category: OutreachCategory = (VALID_CATEGORIES as string[]).includes(rawCategory)
    ? (rawCategory as OutreachCategory)
    : 'company'
