...
const REPORTS: ReportCard[] = [
  { key: 'cybersecurity', href: '/dashboard/cybersecurity', accent: CYAN, title: uiText('generatedUi.u_50ab62def34755ef'), desc: 'Dependency advisory monitoring and technical cybersecurity checks separate from audit readiness reports.' },
