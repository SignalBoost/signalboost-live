...
/**
 * Jobs are billed by the minute while Starting/Running. We intentionally over-estimate from total
 * elapsed duration when available, round up to a whole minute, and never exceed the stage reserve.
 * If timing is absent, keep the full reserve committed rather than inventing a refund.
 */
