...
test('Concierge hands off only explicit Builder objectives and never drops attachments', () => {
  ...
  assert.match(conciergeRoute, /CONCIERGE_DESIGN_ARTIFACT\.test\(objective\) && CONCIERGE_DESIGN_REQUEST\.test\(objective\)/)
  ...
  assert.match(conciergeRoute, /if \(result\.ok === false && designMatched\)/)
  assert.match(conciergeRoute, /internal control-plane code/)
