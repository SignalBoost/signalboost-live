...
**Unsupported medical-claim boundary — IMPLEMENTED:** Requests to create a claim that a medical device extends lifespan refuse directly and redirect to a professional script limited to intended use and clinically/regulatorily validated benefits. They must not be misrouted into live-search synthesis.
