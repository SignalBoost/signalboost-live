...
export const portableProductRegistry = Object.freeze([
  ...
  product(browserAgentEcosystemManifest, { localizationKey: 'browserAgents', glyph: '◇', implementationStatus: 'implemented', implementationClassification: 'implemented_product', sortOrder: 80, route: '/dashboard/supervisor/providers' }),
