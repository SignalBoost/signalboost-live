...
export const marketingSalesManifest: PortableProductManifest = Object.freeze({
  ...
  optionalCapabilities: Object.freeze(['approval-gates', 'native-video-upload', 'oauth-connections']),
  dependencies: Object.freeze(['configured-workflow-host']),
  exclusions: Object.freeze(['guaranteed-business-outcomes', 'guaranteed-reach-or-engagement', 'platform-approval-on-behalf-of-buyer', 'content-scheduling', 'paid-advertising-placement']),
  architectureReferences: Object.freeze(['marketing-sales-core', 'marketing-sales-host', 'lib/outreach/marketing-sales-portable', 'scripts/build-marketing-sales-portable']),
