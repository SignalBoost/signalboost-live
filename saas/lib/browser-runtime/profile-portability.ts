// saas/lib/browser-runtime/profile-portability.ts
//
// SHIM. The real module now lives in the portable at
// lib/portable-browser/browser-profile-portability.ts, because four shipped adapters on the buyer
...
export * from '../portable-browser/browser-profile-portability.ts'
