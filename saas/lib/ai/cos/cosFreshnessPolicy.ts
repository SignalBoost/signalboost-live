...
// content-generation classifier here: that classifier also participates in execution routing.
// We only need to prevent incidental temporal words ("today", "current", dates) from turning
// an otherwise ordinary writing request into public-web verification.
