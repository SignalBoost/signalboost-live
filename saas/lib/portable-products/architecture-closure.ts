...
const declared = Object.freeze<Record<string, Omit<PortableArchitectureEntry, 'productId'>>>({
  ...
  'portable-ai-chief-of-staff': { coreBoundary: 'saas/lib/cos/executive-core', hostBoundary: 'saas/lib/cos', state: 'partial', blockers: Object.freeze(['standalone-host-boundary', 'buyer-owned-runtime-composition']) },
