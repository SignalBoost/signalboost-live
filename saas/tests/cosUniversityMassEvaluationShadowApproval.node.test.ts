...
test('a shadow approval issued during a live run does not steal the infrastructure terminal or exhaust the rolling window', () => {
...
test('a live started evaluation blocks another approval even though its approval has already been consumed', () => {
