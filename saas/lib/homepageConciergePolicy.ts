...
// textTransformationInput module here: that module also carries request-local artifact continuation
// state backed by AsyncLocalStorage/node:async_hooks, which cannot enter the homepage client bundle.
