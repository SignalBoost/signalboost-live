...
test('production telemetry adapter ranks only scoped fresh specialist-execution evidence', async () => {
  ...
  const port = createProductionSpecialistMeshSignalPort({
    ...
    observations: {
      async read() {
        return [
          { schemaVersion: A2A_RUNTIME_OBSERVATION_VERSION, eventId: '1', occurredAt: '2026-09-12T19:59:00Z', durationMs: 3000, tenantId: 'tenant-1', environmentId: 'production', portableId: 'cos', agentId: 'a', skillId: 'self-healing.diagnose', ok: true, mode: 'delegated', executionAttempted: true },
          { schemaVersion: A2A_RUNTIME_OBSERVATION_VERSION, eventId: '2', occurredAt: '2026-09-12T19:58:00Z', durationMs: 9000, tenantId: 'tenant-1', environmentId: 'production', portableId: 'cos', agentId: 'a', skillId: 'self-healing.diagnose', ok: false, mode: 'a2a_transport_unavailable', executionAttempted: true },
