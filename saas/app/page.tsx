...
export default function Home() {
  ...
  >
    ...
    <section className="concierge-panel" aria-label={c('eyebrow')}>
      ...
      {answer ? <article className="answer" aria-live="polite"><div className="answer-label">{c('cosLabel')}</div><div className="answer-content"><AssistantMessage content={answer} /></div><Link href={'/dashboard/assistant?prompt=' + encodeURIComponent(sentPrompt)}>{c('continue')} →</Link></article> : null}
