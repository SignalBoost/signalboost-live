  ...
  return (
    <div style={{ color: '#fff', fontFamily: 'system-ui' }}>
      ...
      <div style={{
        ...
        <div>
          <div style={{ fontSize: 13, color: 'rgba(255,255,255,0.5)', marginBottom: 4 }}>Team seats</div>
          <div style={{ fontSize: 22, fontWeight: 800 }}>
            {seatsUsed} <span style={{ color: 'rgba(255,255,255,0.3)', fontSize: 15 }}>/ {seatsAllowed} used</span>
          </div>
        </div>
        <div style={{
      ...
      {seatsUsed >= seatsAllowed && (
        <div style={{
          ...
          <span>Seat limit reached. Upgrade to add more team members.</span>
      ...
      {message && (
        <div style={{
          ...
          background: message.includes('sent') ? 'rgba(74,222,128,0.1)' : 'rgba(239,68,68,0.1)',
          border: `1px solid ${message.includes('sent') ? 'rgba(74,222,128,0.2)' : 'rgba(239,68,68,0.2)'}`,
